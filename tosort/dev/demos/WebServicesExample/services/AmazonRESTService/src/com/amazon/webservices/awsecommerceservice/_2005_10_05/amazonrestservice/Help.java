 ...
 *         &lt;element name="Shared" type="{http://webservices.amazon.com/AWSECommerceService/2005-10-05}HelpRequest" minOccurs="0"/>
 *         &lt;element name="Request" type="{http://webservices.amazon.com/AWSECommerceService/2005-10-05}HelpRequest" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "Help", namespace = "http://webservices.amazon.com/AWSECommerceService/2005-10-05")
public class Help {
     ...
     *     
     */
    public HelpRequestType getShared() {
        return shared;
    }
     ...
     *     
     */
    public void setShared(HelpRequestType value) {
        this.shared = value;
    }
     ...
     * 
     */
    public List<HelpRequestType> getRequests() {
        if (requests == null) {
            requests = new ArrayList<HelpRequestType>();
        }
     ...
     *     
     */
    public void setRequests(List<HelpRequestType> requests) {
