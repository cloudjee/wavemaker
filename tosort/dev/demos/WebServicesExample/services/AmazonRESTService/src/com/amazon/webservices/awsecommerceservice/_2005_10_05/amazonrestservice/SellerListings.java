 ...
 *         &lt;element ref="{http://webservices.amazon.com/AWSECommerceService/2005-10-05}SellerListing" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "SellerListings", namespace = "http://webservices.amazon.com/AWSECommerceService/2005-10-05")
public class SellerListings {
    ...
    @XmlElement(name = "SellerListing", namespace = "http://webservices.amazon.com/AWSECommerceService/2005-10-05")
    protected List<SellerListing> sellerListings;
     ...
     * 
     */
    public List<SellerListing> getSellerListings() {
        if (sellerListings == null) {
            sellerListings = new ArrayList<SellerListing>();
        }
     ...
     *     
     */
    public void setSellerListings(List<SellerListing> sellerListings) {
