 ...
 *         &lt;element name="Shared" type="{http://webservices.amazon.com/AWSECommerceService/2005-10-05}TransactionLookupRequest" minOccurs="0"/>
 *         &lt;element name="Request" type="{http://webservices.amazon.com/AWSECommerceService/2005-10-05}TransactionLookupRequest" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "TransactionLookup", namespace = "http://webservices.amazon.com/AWSECommerceService/2005-10-05")
public class TransactionLookup {
    ...
    protected TransactionLookupRequestType shared;
    @XmlElement(name = "Request", namespace = "http://webservices.amazon.com/AWSECommerceService/2005-10-05")
    protected List<TransactionLookupRequestType> requests;
     ...
     *     
     */
    public TransactionLookupRequestType getShared() {
        return shared;
    }
     ...
     *     
     */
    public void setShared(TransactionLookupRequestType value) {
        this.shared = value;
    }
     ...
     * 
     */
    public List<TransactionLookupRequestType> getRequests() {
        if (requests == null) {
            requests = new ArrayList<TransactionLookupRequestType>();
        }
     ...
     *     
     */
    public void setRequests(List<TransactionLookupRequestType> requests) {
