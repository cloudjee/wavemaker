...
@XmlType(name = "Address", namespace = "http://webservices.amazon.com/AWSECommerceService/2005-10-05", propOrder = {
    "name",
    "address1",
    "address2",
    "address3",
...
public class AddressType {
    ...
    @XmlElement(name = "Address1", namespace = "http://webservices.amazon.com/AWSECommerceService/2005-10-05")
    protected String address1;
    @XmlElement(name = "Address2", namespace = "http://webservices.amazon.com/AWSECommerceService/2005-10-05")
    protected String address2;
    @XmlElement(name = "Address3", namespace = "http://webservices.amazon.com/AWSECommerceService/2005-10-05")
