    ...
    implements DataServiceManagerAccess, LiveDataService
{
    ...
    public com.data.Users getUsersById(String id) {
        List<com.data.Users> rtn = ((List<com.data.Users> ) dsMgr.invoke(taskMgr.getQueryTask(), (UserdbConstants.getUsersByIdQueryName), id));
        if (rtn.isEmpty()) {
            return null;
        } else {
            return rtn.get(0);
