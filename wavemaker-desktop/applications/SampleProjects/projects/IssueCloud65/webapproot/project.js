...
wm.types = {
	"types": {
		...
		"com.issuecloudv3db.data.Comment": {
			"fields": {
				"cid": {
					"exclude": ["insert"],
					"fieldOrder": 0,
				...
				"issue": {
					...
					"noChange": [],
					"required": true,
					"type": "com.issuecloudv3db.data.Issue"
				},
				"tid": {
					"exclude": [],
					"fieldOrder": 1,
				...
				"user": {
					...
					"noChange": [],
					"required": true,
					"type": "com.issuecloudv3db.data.User"
				}
			},
			"internal": false,
			"liveService": true,
			"service": "issuecloudv3DB"
		},
		"com.issuecloudv3db.data.Issue": {
			"fields": {
				"closedate": {
					"exclude": [],
					"fieldOrder": 4,
				...
				"comments": {
					...
					"noChange": [],
					"required": false,
					"type": "com.issuecloudv3db.data.Comment"
				},
				"createdate": {
					"exclude": [],
					"fieldOrder": 3,
				...
				"project": {
					...
					"noChange": [],
					"required": true,
					"type": "com.issuecloudv3db.data.Project"
				},
				"status": {
					"exclude": [],
					"fieldOrder": 10,
				...
				"versionByFixedVid": {
					...
					"noChange": [],
					"required": false,
					"type": "com.issuecloudv3db.data.Version"
				},
				"versionByReportedVid": {
					"exclude": [],
					"fieldOrder": 13,
					"fieldSubType": null,
					"include": [],
		...
		"com.issuecloudv3db.data.Project": {
			"fields": {
				"description": {
					"exclude": [],
					"fieldOrder": 3,
		...
		"com.issuecloudv3db.data.Status": {
			"fields": {
				"name": {
					"exclude": [],
					"fieldOrder": 1,
		...
		"com.issuecloudv3db.data.Tenant": {
			"fields": {
				"accountnumber": {
					"exclude": [],
					"fieldOrder": 3,
		...
		"com.issuecloudv3db.data.Version": {
			"fields": {
				"description": {
					"exclude": [],
					"fieldOrder": 3,
...
IssueCloud65.prototype._css = '.mobile .PageBackground {\
color: white !important;\
background: rgb(68,68,68) !important; /* Old browsers */\
/* IE9 SVG, needs conditional override of "filter" to "none" */\
background: url(data:image/svg+xml;base64,);\
background: -moz-linear-gradient(top, rgba(68,68,68,1) 1%, rgba(17,17,17,1) 37%, rgba(2,1,2,1) 100%) !important; /* FF3.6+ */\
background: -webkit-gradient(linear, left top, left bottom, color-stop(1%,rgba(68,68,68,1)), color-stop(37%,rgba(17,17,17,1)), color-stop(100%,rgba(2,1,2,1))) !important; /* Chrome,Safari4+ */\
background: -webkit-linear-gradient(top, rgba(68,68,68,1) 1%,rgba(17,17,17,1) 37%,rgba(2,1,2,1) 100%) !important; /* Chrome10+,Safari5.1+ */\
background: -o-linear-gradient(top, rgba(68,68,68,1) 1%,rgba(17,17,17,1) 37%,rgba(2,1,2,1) 100%) !important; /* Opera 11.10+ */\
background: -ms-linear-gradient(top, rgba(68,68,68,1) 1%,rgba(17,17,17,1) 37%,rgba(2,1,2,1) 100%) !important; /* IE10+ */\
background: linear-gradient(top, rgba(68,68,68,1) 1%,rgba(17,17,17,1) 37%,rgba(2,1,2,1) 100%) !important; /* W3C */\
filter: progid:DXImageTransform.Microsoft.gradient( startColorstr="#444444", endColorstr="#020102",GradientType=0 ); /* IE6-8 */\
}\
.mobile  .ToolBar {\
background: rgba(2,1,2,1) !important; /* Old browsers */\
}\
...
.mobile .wmtogglebuttonpanel {\
border-radius: 8px;\
-webkit-border-radius: 8px;\
}\
.mobile .wmtogglebuttonpanel .wmbutton:first-child {\
border-radius-topleft: 8px !important;\
border-radius-bottomleft: 8px !important;\
-webkit-border-top-left-radius: 8px !important;\
-webkit-border-bottom-left-radius: 8px !important;\
}\
.mobile .TogglePanel .wmbutton:last-child {\
border-radius-topright: 8px !important;\
border-radius-bottomright: 8px !important;\
-webkit-border-top-right-radius: 8px !important;\
-webkit-border-bottom-right-radius: 8px !important;\
}\
.mobile .ToggleFooter.wmtogglebuttonpanel {\
border-radius-topleft: 8px !important;\
border-radius-topright: 8px !important;\
border-radius-bottomleft: 0px !important;\
...
.mobile .ToggleFooter.wmtogglebuttonpanel .wmbutton:first-child {\
border-radius-topleft: 8px !important;\
border-radius-bottomleft: 0px !important;\
-webkit-border-top-left-radius: 8px !important;\
-webkit-border-bottom-left-radius: 0px !important;\
}\
.mobile .ToggleFooter.wmtogglebuttonpanel .wmbutton:last-child {\
border-radius-topright: 8px !important;\
border-radius-bottomright: 0px !important;\
-webkit-border-top-right-radius: 8px !important;\
-webkit-border-bottom-right-radius: 0px !important;\
