...
/**
 *  Operations for service "issuecloudv3DB"
 *  02/12/2013 12:08:03
 * 
 */
@SuppressWarnings("unchecked")
public class Issuecloudv3DB
    implements DataServiceManagerAccess, LiveDataService
{
    ...
    public com.issuecloudv3db.data.Version getVersionById(Integer id, PagingOptions pagingOptions) {
        List<com.issuecloudv3db.data.Version> rtn = ((List<com.issuecloudv3db.data.Version> ) dsMgr.invoke(taskMgr.getQueryTask(), (Issuecloudv3DBConstants.getVersionByIdQueryName), id, pagingOptions));
        if (rtn.isEmpty()) {
            return null;
        } else {
            return rtn.get(0);
