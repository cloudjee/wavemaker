Main.widgets = {
	...
	layoutBox1: ["wm.Layout", {"height":"800px","horizontalAlign":"left","verticalAlign":"top"}, {}, {
		labelTitlePanel: ["wm.Panel", {"height":"60px","horizontalAlign":"left","layoutKind":"left-to-right","verticalAlign":"middle","width":"100%"}, {}, {
			pictureCrazyLog: ["wm.Picture", {"aspect":"h","border":"0","height":"100%","source":"http://1.bp.blogspot.com/-YMJZzUXMEPc/T0m9G_nM52I/AAAAAAAAAUM/83-EwT667gA/s1600/Crazy+Eddie.jpg","width":"120px"}, {}],
			labelTitle: ["wm.Label", {"border":"0","caption":"The Priceinator","height":"100%","padding":"4","singleLine":false,"styles":{"fontWeight":"bold","fontSize":"38px","textAlign":"center"},"width":"100%"}, {"onclick":"layerPriceTool"}],
			pictureWMLogo: ["wm.Picture", {"aspect":"h","border":"0","height":"100%","source":"resources/images/logos/wm-logo-fancy.png","width":"120px"}, {}]
		}],
		layers1: ["wm.Layers", {"margin":"3,0,0,0"}, {}, {
			layerPriceTool: ["wm.Layer", {"borderColor":"","caption":"layer1","horizontalAlign":"center","themeStyleType":"","verticalAlign":"top"}, {}, {
				...
				panelDbResults: ["wm.Panel", {"height":"100%","horizontalAlign":"center","verticalAlign":"top","width":"100%"}, {}, {
					label1: ["wm.Label", {"border":"0","caption":"Our Insane Price","padding":"4","styles":{"fontSize":"20px"},"width":"177px"}, {}],
					...
					simpleForm2: ["wm.SimpleForm", {"fitToContentHeight":true,"height":"70px","horizontalAlign":"center","verticalAlign":"top"}, {}, {
						...
						descriptionEditor1: ["wm.Text", {"caption":"Description","captionSize":"120px","changeOnKey":true,"desktopHeight":"26px","emptyValue":"emptyString","formField":"description","height":"35px","padding":"2,14,2,2","width":"600px"}, {}, {
							binding: ["wm.Binding", {}, {}, {
						...
						priceEditor2Panel: ["wm.Panel", {"height":"35px","horizontalAlign":"left","layoutKind":"left-to-right","verticalAlign":"top","width":"600px"}, {}, {
							priceEditor2: ["wm.Currency", {"caption":"Price","captionSize":"80px","changeOnKey":true,"desktopHeight":"26px","emptyValue":"zero","formField":"price","height":"35px","width":"100%"}, {}, {
								binding: ["wm.Binding", {}, {}, {
									wire: ["wm.Wire", {"expression":undefined,"source":"dojoGridCrazyDbProducts.selectedItem.price","targetProperty":"dataValue"}, {}]
								}]
							}],
							specialInstructionsEditor1: ["wm.Text", {"caption":"Notes","captionSize":"60px","changeOnKey":true,"desktopHeight":"26px","emptyValue":"emptyString","formField":"specialInstructions","height":"35px","width":"100%"}, {}, {
								binding: ["wm.Binding", {}, {}, {
				...
				panelShopSearchResults: ["wm.Panel", {"enableTouchHeight":true,"height":"100%","horizontalAlign":"center","verticalAlign":"top","width":"300%"}, {}, {
					...
					label4: ["wm.Label", {"border":"0","caption":"The Competition","padding":"4","styles":{"fontSize":"20px"},"width":"174px"}, {}],
					textShopDescription: ["wm.Text", {"caption":"Description","captionSize":"120px","desktopHeight":"35px","displayValue":"","height":"35px","padding":"2,14,2,2","width":"600px"}, {}, {
						binding: ["wm.Binding", {}, {}, {
					...
					simpleForm1: ["wm.SimpleForm", {"fitToContentHeight":true,"height":"70px","horizontalAlign":"center","layoutKind":"left-to-right","verticalAlign":"top","width":"600px"}, {}, {
						...
						priceEditor1Panel: ["wm.Panel", {"desktopHeight":"35px","enableTouchHeight":true,"height":"70px","horizontalAlign":"left","mobileHeight":"70px","verticalAlign":"top","width":"100%"}, {}, {
							priceEditor1: ["wm.Currency", {"caption":"Price","captionSize":"80px","changeOnKey":true,"desktopHeight":"26px","emptyValue":"emptyString","formField":"price","height":"35px","required":undefined,"width":"100%"}, {}, {
								binding: ["wm.Binding", {}, {}, {
									wire: ["wm.Wire", {"expression":undefined,"source":"list2.selectedItem.product.inventories.price","targetProperty":"dataValue"}, {}]
								}]
							}],
							shippingEditor1: ["wm.Currency", {"caption":"Shipping","captionSize":"80px","changeOnKey":true,"desktopHeight":"26px","emptyValue":"emptyString","formField":"shipping","height":"35px","required":undefined,"width":"100%"}, {}, {
								binding: ["wm.Binding", {}, {}, {
						...
						panel1: ["wm.Panel", {"desktopHeight":"70px","enableTouchHeight":true,"height":"70px","horizontalAlign":"left","mobileHeight":"70px","verticalAlign":"top","width":"100%"}, {}, {
							currencyEditor1: ["wm.Text", {"caption":"Currency","captionSize":"80px","changeOnKey":true,"desktopHeight":"26px","emptyValue":"emptyString","formField":"currency","height":"35px","required":undefined,"width":"100%"}, {}, {
								binding: ["wm.Binding", {}, {}, {
									wire: ["wm.Wire", {"expression":undefined,"source":"list2.selectedItem.product.inventories.currency","targetProperty":"dataValue"}, {}]
								}]
							}],
							availabilityEditor1: ["wm.Text", {"caption":"Availability","captionSize":"80px","changeOnKey":true,"desktopHeight":"26px","emptyValue":"emptyString","formField":"availability","height":"35px","required":undefined,"width":"100%"}, {}, {
								binding: ["wm.Binding", {}, {}, {
			...
			layerAbout: ["wm.Layer", {"borderColor":"","caption":"layer2","horizontalAlign":"left","themeStyleType":"","verticalAlign":"top"}, {}, {
				pageContainer1: ["wm.PageContainer", {"border":"0","deferLoad":true,"pageName":"PageAbout","subpageEventlist":{},"subpageMethodlist":{},"subpageProplist":{}}, {}]
			}]
		}]
	}]
}