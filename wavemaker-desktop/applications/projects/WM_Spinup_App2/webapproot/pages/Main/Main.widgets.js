				...
				TopLayers: ["wm.Layers", {}, {}, {
					loginLayer: ["wm.Layer", {"borderColor":"","caption":"layer1","horizontalAlign":"left","layoutKind":"left-to-right","themeStyleType":"","verticalAlign":"top"}, {}, {
						ContentPanel1: ["wm.Panel", {"_classes":{"domNode":["largerLineHeight"]},"height":"100%","horizontalAlign":"left","styles":{"backgroundColor":"","color":"","fontFamily":"Arial, Tahoma, Helvetica,Verdana,Sans Serif","fontSize":"undefinedpx"},"verticalAlign":"top","width":"65%"}, {}, {
							Content1: ["wm.Html", {"autoScroll":false,"height":"32px","html":"WaveMaker for Cloud Foundry -- <b>Dev Edition</b>","minDesktopHeight":15,"styles":{"fontSize":"26px","color":""}}, {}],
							html1: ["wm.Html", {"_classes":{"domNode":["","largerLineHeight",""]},"autoScroll":false,"height":"98px","html":"<b>Logging in will replace any existing studio found with the latest unreleased build.</b><br> The version deployed will be the latest artifact from the WaveMaker jenkins server. <br>The deployed studio may be unstable or have serious defects. <br>If you are looking of the current stable version of WaveMaker on Cloud Foundry, use <a href=\"http://wavemaker.cloudfoundry.com\">WaveMaker.CloudFoundry.com</a>. ","margin":"14,0,0,0","minDesktopHeight":15,"styles":{"color":"","fontSize":"undefinedpx"}}, {}],
