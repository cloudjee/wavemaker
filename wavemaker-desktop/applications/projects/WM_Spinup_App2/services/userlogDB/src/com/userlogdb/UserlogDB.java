...
/**
 *  Operations for service "userlogDB"
 *  05/29/2012 17:24:59
 * 
 */
    ...
    implements DataServiceManagerAccess, LiveDataService
{
    ...
    public com.userlogdb.data.Userlogin getUserloginById(Integer id, PagingOptions pagingOptions) {
        List<com.userlogdb.data.Userlogin> rtn = ((List<com.userlogdb.data.Userlogin> ) dsMgr.invoke(taskMgr.getQueryTask(), (UserlogDBConstants.getUserloginByIdQueryName), id, pagingOptions));
        if (rtn.isEmpty()) {
            return null;
        } else {
            return rtn.get(0);
