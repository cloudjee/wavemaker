...
public class StudioUpgradeDialog extends JDialog {
    ...
    private void init() {
        ...
        this.getContentPane().add(
            new JLabel("<html>Congratulations! You have successfully installed WaveMaker v" + this.version
                + "<P>Clear your browser's cache of previous version to ensure proper operation of Studio</html>"),
            new GridBagConstraints(0, 0, 1, 1, 0.0, 0.0, GridBagConstraints.NORTHWEST, GridBagConstraints.NONE, new Insets(2, 2, 2, 2), 0, 0));
        this.getContentPane().add(this.oldProjectsButton,
            new GridBagConstraints(0, 1, 1, 1, 0.0, 0.0, GridBagConstraints.NORTHWEST, GridBagConstraints.NONE, new Insets(2, 2, 2, 2), 0, 0));
        this.getContentPane().add(new JLabel("Or"),
            new GridBagConstraints(0, 2, 1, 1, 0.0, 0.0, GridBagConstraints.NORTHWEST, GridBagConstraints.NONE, new Insets(2, 2, 2, 2), 0, 0));
        this.getContentPane().add(this.copyProjectsButton,
            new GridBagConstraints(0, 3, 1, 1, 0.0, 0.0, GridBagConstraints.NORTHWEST, GridBagConstraints.NONE, new Insets(2, 2, 2, 2), 0, 0));
        this.subPanel = new JPanel();
        this.subPanel.setLayout(new GridBagLayout());
        this.subPanel.setBorder(new TitledBorder("Project Settings:"));
        this.getContentPane().add(this.subPanel,
            new GridBagConstraints(0, 4, 1, 1, 1.0, 1.0, GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(2, 2, 2, 2), 0, 0));
        this.subPanel.add(new JLabel("New Projects Directory:"), new GridBagConstraints(0, 0, 1, 1, 0.0, 0.1, GridBagConstraints.EAST,
            GridBagConstraints.VERTICAL, new Insets(2, 2, 2, 2), 0, 0));
        this.subPanel.add(this.projectsPathField, new GridBagConstraints(1, 0, 1, 1, 0.6, 0.1, GridBagConstraints.CENTER, GridBagConstraints.BOTH,
            new Insets(2, 2, 2, 2), 0, 0));
        this.browseButton = new JButton("Browse...");
        this.subPanel.add(this.browseButton, new GridBagConstraints(2, 0, 1, 1, 0.0, 0.1, GridBagConstraints.WEST, GridBagConstraints.VERTICAL,
            new Insets(2, 2, 2, 2), 0, 0));
        // OK button
        this.okButton = new JButton("OK");
        this.getContentPane().add(this.okButton,
            new GridBagConstraints(0, 5, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.NONE, new Insets(2, 2, 4, 2), 0, 0));
        this.pack();
        ...
        this.browseButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent ev) {
                final JFileChooser jfc = new JFileChooser(StudioUpgradeDialog.this.existingDir);
        ...
        this.okButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent arg0) {
                ...
                if (upgradeSelected()) {
                    ...
                    File proposed = new File(StudioUpgradeDialog.this.projectsPathField.getText());
                    if (!proposed.equals(StudioUpgradeDialog.this.projectsDir)) {
                        ...
                        if (proposed.exists()) {
                            ...
                            if (proposed.isDirectory()) {
                                ...
                                JOptionPane.showMessageDialog(JOptionPane.getRootFrame(), "\"" + proposed.getAbsolutePath()
                            ...
                            if (proposed.mkdirs()) {
                                ...
                                JOptionPane.showMessageDialog(JOptionPane.getRootFrame(), "", "Error Creating Projects Directory:",
                                    JOptionPane.ERROR_MESSAGE);
                                success = false;
                            }
                        }
