...
public final class JSONMarshaller {
    ...
    /**
     * Marshal the given Object into a JSON-formatted character stream (written
     * out onto the writer parameter). This method will not attempt to sort the
     * output.
     * 
     * @param obj
     *                The Object to marshal; this must be an JavaBean-style
     *                Object, a Collection, or an array.
     ...
     * @return The JSON-formatted String representation of obj.
     */
    public static String marshal(Object obj, JSONState jsonState)
            throws IOException {
     ...
     *                Any configuration.
     * @param sort
     *                True if the output should be sorted (only bean properties
     *                will be sorted, currently).
     * @return The JSON-formatted String representation of obj.
     */
    public static String marshal(Object obj, JSONState jsonState, boolean sort)
            throws IOException {
     ...
     */
    public static String marshal(Object obj, JSONState jsonState,
            FieldDefinition fieldDefinition, boolean sort)
            throws IOException {
     ...
     * 
     * @param writer
     *                The Writer to write the JSON-formatted representation of
     *                obj to.
     * @param obj
     *                The Object to marshal; this must be an JavaBean-style
     *                Object, a Collection, or an array.
     ...
     *                will be sorted, currently).
     */
    public static void marshal(Writer writer, Object obj, JSONState jsonState,
    ...
    /**
     * Marshal the given Object into a JSON-formatted character stream (written
     * out onto the writer parameter).  This will infer the root object type
     * from the type of the obj parameter.
     * 
     * @param writer
     *                The Writer to write the JSON-formatted representation of
     *                obj to.
    ...
    public static void marshal(Writer writer, Object obj, JSONState jsonState,
        ...
        if (null==obj) {
            fieldDefinition = ReflectTypeUtils.getFieldDefinition((Type) null,
                    typeState, false, null);
        } else {
            fieldDefinition = ReflectTypeUtils.getFieldDefinition(obj.getClass(),
                    typeState, false, null);
        }
     ...
     */
    public static void marshal(Writer writer, Object obj, JSONState jsonState,
            FieldDefinition rootFieldDefinition, boolean sort,
            boolean prettyPrint) throws IOException {

        TypeState typeState = jsonState.getTypeState();
        
        doMarshal(writer, obj, obj, jsonState, sort, true, new Stack<Object>(),
                new Stack<String>(),
                rootFieldDefinition, 0, typeState,
                prettyPrint, 0, Logger.getLogger(JSONMarshaller.class));
    }
     ...
     * 
     * CYCLE_DETECTED_OBJECT will be returned if a cycle was detected at a lower
     * level, and this level needs to be not written.
     * 
     * fieldDefinition should never be null; its enclosed typeDefinition may
     * very well be null.
     */
    protected static Object doMarshal(Writer writer, Object obj, Object root,
            JSONState js, boolean sort, boolean topLevel,
            Stack<Object> touchedObjects, Stack<String> propertyNames,
            FieldDefinition fieldDefinition, int arrayLevel,
            TypeState typeState,
            boolean prettyPrint, int level, Logger logger)
            throws IOException {
        ...
        try {
            ...
            if (null!=js.getValueTransformer()) {
                Tuple.Three<Object, FieldDefinition, Integer> tuple =
                    js.getValueTransformer().transformToJSON(obj,
                            fieldDefinition, arrayLevel, root,
                            getPropertyName(propertyNames, js),
                            js.getTypeState());
                if (null != tuple) {
                    obj = tuple.v1;
            ...
            if (arrayLevel == fieldDefinition.getDimensions() &&
                ...
                ((WriteObjectConverter) fieldDefinition.getTypeDefinition()).
                        writeObject(obj, root, getPropertyName(propertyNames, js),
                        writer);
            } else if (null == obj) {
                writer.write("null");
            ...
            // handle arrays & Collections
                ...
                if (obj instanceof Collection) {
                    for (Object elem : (Collection<?>) obj) {
                        ...
                        doMarshal(writer, elem, root, js, sort, false,
                                touchedObjects, propertyNames, fieldDefinition,
                                arrayLevel+1, typeState, prettyPrint,
                                level, logger);
            ...
            // handle maps & objects
                ...
                handleObject(obj, root, js, writer, touchedObjects,
                        propertyNames, sort, fieldDefinition, arrayLevel,
                        typeState, prettyPrint, level, logger);
            }
     ...
     * @throws IOException
     */
    private static void handleObject(Object obj, Object root, JSONState js,
            Writer writer, Stack<Object> touchedObjects,
            Stack<String> propertyNames, boolean sort,
            FieldDefinition fieldDefinition, int arrayLevel, TypeState typeState,
            boolean prettyPrint, int level, Logger logger)
            throws IOException {
        ...
        if (obj instanceof Map ||
            ...
            for (Entry<?, ?> entry : entries==null?((Map<?, ?>) obj).entrySet():entries) {
                ...
                firstProperty = handleObjectInternal(obj, root, key,
                        entry.getValue(), firstProperty, js, writer,
                        touchedObjects, propertyNames, sort, fieldDefinition,
                        arrayLevel, typeState, prettyPrint,
                        level+1, logger);
            }
            ...
            if (otd.getTypeName().equals(obj.getClass().getName())) {
                for (Entry<String, FieldDefinition> entry: otd.getFields().entrySet()) {
                    ...
                    firstProperty = handleObjectInternal(obj, root, name,
                            value, firstProperty, js, writer, touchedObjects,
                            propertyNames, sort, fieldDefinition, 0, typeState,
                            prettyPrint, level+1, logger);
                }
            }
        } else {
    ...
    private static boolean handleObjectInternal(Object object, Object root,
            String key, Object value, boolean firstProperty, JSONState js,
            Writer writer, Stack<Object> touchedObjects,
            Stack<String> propertyNames, boolean sort,
            FieldDefinition fieldDefinition, int arrayLevel,
            TypeState typeState,
        ...
        try {
            ...
            doMarshal(writer, value, root, js, sort, false, touchedObjects,
                    propertyNames, fieldDefinition, arrayLevel, typeState,
    ...
    private static void writeIndents(Writer writer, int level)
            throws IOException {
    ...
    private static String getPropertyName(Stack<String> propertyNames,
            JSONState js) {
        return StringUtils.join(propertyNames.subList(js.getTrimStackLevel(),
                propertyNames.size()), AlternateJSONTransformer.PROP_SEP);
    }
    
    private static boolean isCycle(Object obj, Stack<Object> touchedObjects,
            String propertyName, JSONState js) {
        
        boolean cycle = -1 != touchedObjects.search(obj);
        if (cycle && null!=js.getRequiredProperties() &&
                js.getRequiredProperties().contains(propertyName)) {
            cycle = false;
        }
        return cycle;
    }
