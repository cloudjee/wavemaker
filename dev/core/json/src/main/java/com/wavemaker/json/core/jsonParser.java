...
public class jsonParser extends Parser {
    public static final String[] tokenNames = new String[] {
        "<invalid>", "<EOR>", "<DOWN>", "<UP>", "BEGIN_ARRAY", "END_ARRAY", "BEGIN_OBJ", "END_OBJ", "NAME_SEP", "VALUE_SEP", "FALSE", "NULL", "TRUE", "NUMBER", "STRING", "JS_IDENT", "MINUS", "INT", "FRAC", "EXP", "DECIMAL_POINT", "DIGIT", "DIGIT19", "E", "PLUS", "ZERO", "QUOTATION_MARK", "CHAR", "UNESCAPED", "ESCAPE", "HEXDIGIT", "WHITESPACE", "JS_IDENT_FIRST"
    };
    ...
    public String getGrammarFileName() { return "src/com/wavemaker/json/core/json.g"; }
    ...
    // $ANTLR start "value"
    // src/com/wavemaker/json/core/json.g:91:1: value returns [Object value] : ( FALSE | NULL | TRUE | object | array | NUMBER | STRING );
        ...
        try {
            ...
            switch (alt2) {
                case 1 :
                    ...
                    {
                    match(input,FALSE,FOLLOW_FALSE_in_value149); 
                     value = Boolean.FALSE; 
                ...
                case 2 :
                    ...
                    {
                    match(input,NULL,FOLLOW_NULL_in_value156); 
                     value = null; 
                ...
                case 3 :
                    ...
                    {
                    match(input,TRUE,FOLLOW_TRUE_in_value163); 
                     value = Boolean.TRUE; 
                ...
                case 6 :
                    ...
                    {
                    NUMBER5=(Token)match(input,NUMBER,FOLLOW_NUMBER_in_value184); 
                ...
                case 7 :
                    ...
                    {
                    STRING6=(Token)match(input,STRING,FOLLOW_STRING_in_value193); 
    ...
    // $ANTLR start "object"
    // src/com/wavemaker/json/core/json.g:112:1: object returns [JSONObject value] : BEGIN_OBJ ( member[value] ( VALUE_SEP member[value] )* )? ( VALUE_SEP )? END_OBJ ;
    public final JSONObject object() throws RecognitionException {
        JSONObject value = null;

        try {
            // src/com/wavemaker/json/core/json.g:112:35: ( BEGIN_OBJ ( member[value] ( VALUE_SEP member[value] )* )? ( VALUE_SEP )? END_OBJ )
            // src/com/wavemaker/json/core/json.g:113:2: BEGIN_OBJ ( member[value] ( VALUE_SEP member[value] )* )? ( VALUE_SEP )? END_OBJ
            {

            		value = new JSONObject();
            	
            match(input,BEGIN_OBJ,FOLLOW_BEGIN_OBJ_in_object213); 
                ...
                case 1 :
                    ...
                    do {
                    	...
                    	case 1 :
                    	    ...
                    	    {
                    	    match(input,VALUE_SEP,FOLLOW_VALUE_SEP_in_object220); 
            ...
            switch (alt5) {
                case 1 :
                    // src/com/wavemaker/json/core/json.g:116:56: VALUE_SEP
                    {
                    match(input,VALUE_SEP,FOLLOW_VALUE_SEP_in_object229); 
            ...
            match(input,END_OBJ,FOLLOW_END_OBJ_in_object232); 
    ...
    // $ANTLR start "member"
    // src/com/wavemaker/json/core/json.g:118:1: member[JSONObject object] : ( STRING NAME_SEP value | JS_IDENT NAME_SEP value );
        ...
        try {
            ...
            switch (alt6) {
                case 1 :
                    ...
                    {
                    STRING7=(Token)match(input,STRING,FOLLOW_STRING_in_member244); 
                    match(input,NAME_SEP,FOLLOW_NAME_SEP_in_member246); 
                ...
                case 2 :
                    ...
                    {
                    JS_IDENT9=(Token)match(input,JS_IDENT,FOLLOW_JS_IDENT_in_member256); 
                    match(input,NAME_SEP,FOLLOW_NAME_SEP_in_member258); 
    ...
    // $ANTLR start "array"
    // src/com/wavemaker/json/core/json.g:134:1: array returns [JSONArray array] : BEGIN_ARRAY (va= value ( VALUE_SEP vap= value )* ( VALUE_SEP )? )? END_ARRAY ;
    public final JSONArray array() throws RecognitionException {
        ...
        try {
            // src/com/wavemaker/json/core/json.g:142:33: ( BEGIN_ARRAY (va= value ( VALUE_SEP vap= value )* ( VALUE_SEP )? )? END_ARRAY )
            // src/com/wavemaker/json/core/json.g:143:2: BEGIN_ARRAY (va= value ( VALUE_SEP vap= value )* ( VALUE_SEP )? )? END_ARRAY
            {

            		array = new JSONArray();
            	
            match(input,BEGIN_ARRAY,FOLLOW_BEGIN_ARRAY_in_array281); 
                ...
                case 1 :
                    ...
                    do {
                    	...
                    	case 1 :
                    	    ...
                    	    {
                    	    match(input,VALUE_SEP,FOLLOW_VALUE_SEP_in_array301); 
                    ...
                    switch (alt8) {
                        case 1 :
                            // src/com/wavemaker/json/core/json.g:150:13: VALUE_SEP
                            {
                            match(input,VALUE_SEP,FOLLOW_VALUE_SEP_in_array323); 
            ...
            match(input,END_ARRAY,FOLLOW_END_ARRAY_in_array332); 
