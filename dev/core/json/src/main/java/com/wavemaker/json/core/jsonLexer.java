...
public class jsonLexer extends Lexer {
        ...
        try {
            ...
            switch (alt1) {
                case 1 :
                    ...
                    mMINUS(); 
                    MINUS1 = new CommonToken(input, Token.INVALID_TOKEN_TYPE, Token.DEFAULT_CHANNEL, MINUS1Start104, getCharIndex()-1);
            ...
            mINT(); 
            INT2 = new CommonToken(input, Token.INVALID_TOKEN_TYPE, Token.DEFAULT_CHANNEL, INT2Start107, getCharIndex()-1);
            ...
            switch (alt2) {
                case 1 :
                    ...
                    mFRAC(); 
                    FRAC3 = new CommonToken(input, Token.INVALID_TOKEN_TYPE, Token.DEFAULT_CHANNEL, FRAC3Start109, getCharIndex()-1);
            ...
            switch (alt3) {
                case 1 :
                    ...
                    mEXP(); 
                    EXP4 = new CommonToken(input, Token.INVALID_TOKEN_TYPE, Token.DEFAULT_CHANNEL, EXP4Start112, getCharIndex()-1);
    ...
    public final void mCHAR() throws RecognitionException {
        try {
            // src/com/wavemaker/json/core/json.g:237:2: ( UNESCAPED | ESCAPE ( '\"' | '\\\\' | '/' | 'b' | 'f' | 'n' | 'r' | 't' | 'u' HEXDIGIT HEXDIGIT HEXDIGIT HEXDIGIT ) )
            int alt11=2;
            ...
            switch (alt11) {
                case 1 :
                    ...
                    break;
                case 2 :
                    // src/com/wavemaker/json/core/json.g:237:16: ESCAPE ( '\"' | '\\\\' | '/' | 'b' | 'f' | 'n' | 'r' | 't' | 'u' HEXDIGIT HEXDIGIT HEXDIGIT HEXDIGIT )
                    {
                    mESCAPE(); 
                    // src/com/wavemaker/json/core/json.g:237:23: ( '\"' | '\\\\' | '/' | 'b' | 'f' | 'n' | 'r' | 't' | 'u' HEXDIGIT HEXDIGIT HEXDIGIT HEXDIGIT )
                    int alt10=9;
                    switch ( input.LA(1) ) {
                    case '\"':
                        {
    ...
    public void mTokens() throws RecognitionException {
        // src/com/wavemaker/json/core/json.g:1:8: ( BEGIN_ARRAY | END_ARRAY | BEGIN_OBJ | END_OBJ | NAME_SEP | VALUE_SEP | NULL | TRUE | FALSE | NUMBER | STRING | WHITESPACE | JS_IDENT )
        int alt14=13;
    ...
    static final String DFA14_eotS =
        "\7\uffff\3\15\4\uffff\6\15\1\27\1\30\1\15\2\uffff\1\32\1\uffff";
    static final String DFA14_eofS =
        "\33\uffff";
    static final String DFA14_minS =
        "\1\11\6\uffff\1\165\1\162\1\141\4\uffff\1\154\1\165\2\154\1\145"+
        "\1\163\2\44\1\145\2\uffff\1\44\1\uffff";
    static final String DFA14_maxS =
        "\1\175\6\uffff\1\165\1\162\1\141\4\uffff\1\154\1\165\2\154\1\145"+
        "\1\163\2\172\1\145\2\uffff\1\172\1\uffff";
    static final String DFA14_acceptS =
        "\1\uffff\1\1\1\2\1\3\1\4\1\5\1\6\3\uffff\1\12\1\13\1\14\1\15\11"+
        "\uffff\1\7\1\10\1\uffff\1\11";
    static final String DFA14_specialS =
        "\33\uffff}>";
    static final String[] DFA14_transitionS = {
            "\2\14\2\uffff\1\14\22\uffff\1\14\1\uffff\1\13\1\uffff\1\15\7"+
            "\uffff\1\6\1\12\2\uffff\12\12\1\5\6\uffff\32\15\1\1\1\uffff"+
            "\1\2\1\uffff\1\15\1\uffff\5\15\1\11\7\15\1\7\5\15\1\10\6\15"+
            "\1\3\1\uffff\1\4",
            "",
            "",
            "",
