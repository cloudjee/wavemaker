...
public class TestReflectTypeUtils extends WMTestCase {
    ...
    public void testGetListTypeDefinition() throws Exception {
        ...
        ListTypeDefinition ltd_one = ReflectTypeUtils.getListTypeDefinition(
                List.class, typeState, false);
        ListTypeDefinition ltd_two = ReflectTypeUtils.getListTypeDefinition(
                List.class, typeState, false);
    ...
    public void testGetDimensionsAndType() throws Exception {
        ...
        sample = ReflectTypeUtils.getArrayDimensions(ClassUtils.forName("int"),
                new ReflectTypeState(), false);
    ...
    public void testGetDimensionsAndType_BasicListTypes_BoolValList()
            throws Exception {
        ...
        sample = ReflectTypeUtils.getArrayDimensions(m.getGenericReturnType(),
                new ReflectTypeState(), false);
    ...
    public void testGetDimensionsAndType_BasicListTypes_CharValListList()
            throws Exception {
    ...
    public void testGetDimensionsAndType_ArrayNestedInList_ListListStringArr()
            throws Exception {
        ...
        assertEquals(List.class.getName(), sample.v2.get(0).getTypeName());
        assertEquals(List.class.getName(), sample.v2.get(1).getTypeName());
        assertEquals(ClassUtils.forName("java.lang.String[]").getName(),
                sample.v2.get(2).getTypeName());
    }
    
    public void testGetDimensionsAndType_ListSetMapType_Complicated()
            throws Exception {
    ...
    public void testGetFieldDefinition_Type() throws Exception {
        ...
        assertEquals(String.class.getName(),
                fd.getTypeDefinition().getTypeName());
        ...
        fd = ReflectTypeUtils.getFieldDefinition(m.getGenericReturnType(), ts,
                false, null);
    ...
    public void testGetTypeDefinition() throws Exception {
        ...
        TypeDefinition td = ReflectTypeUtils.getTypeDefinition(String.class, typeState,
                false);
        assertNotNull(td);
    ...
    public void testBasicTypes() throws Exception {
        ...
        ReflectTypeState typeState = new ReflectTypeState();
        int start = typeState.getKnownTypes().size();
        TypeDefinition root = ReflectTypeUtils.getTypeDefinition(BasicTypes.class,
                typeState, false);
        assertEquals(4, typeState.getKnownTypes().size() - start);
        ...
        assertEquals(typeState.getType(Long.class.getName()),
                otd.getFields().get("biglongval").getTypeDefinition());
        assertEquals(typeState.getType(boolean.class.getName()),
                otd.getFields().get("boolval").getTypeDefinition());
        assertEquals(typeState.getType(int.class.getName()),
                otd.getFields().get("intval").getTypeDefinition());
        
        assertNotNull(typeState.getType(ReflectTypeUtils.getTypeName(Long.class)));
        assertTrue(typeState.getType(ReflectTypeUtils.getTypeName(Long.class))
                instanceof PrimitiveTypeDefinition);
        ...
        assertTrue(typeState.getType(ReflectTypeUtils.getTypeName(int.class))
                instanceof PrimitiveTypeDefinition);
        ...
        assertTrue(typeState.getType(ReflectTypeUtils.getTypeName(boolean.class))
                instanceof PrimitiveTypeDefinition);
    ...
    public void testBasicListTypes() throws Exception {
        ...
        ReflectTypeState typeState = new ReflectTypeState();
        int start = typeState.getKnownTypes().size();
        TypeDefinition root = ReflectTypeUtils.getTypeDefinition(BasicListTypes.class,
                typeState, false);
        ...
        assertEquals("[[Ljava.lang.Long;",
                field.getArrayTypes().get(0).getTypeName());
        ...
        assertEquals(typeState.getType(Character.class.getName()),
                field.getTypeDefinition());
        assertEquals(2, field.getDimensions());
    ...
    public void testMapType() throws Exception {
        ...
        TypeDefinition root = ReflectTypeUtils.getTypeDefinition(type,
                typeState, false);
        ...
        assertEquals(String.class.getName(),
                mtd.getKeyFieldDefinition().getTypeDefinition().getTypeName());
        assertTrue(mtd.getKeyFieldDefinition().getTypeDefinition() instanceof PrimitiveTypeDefinition);
        assertEquals(String.class.getName(),
                mtd.getValueFieldDefinition().getTypeDefinition().getTypeName());
    ...
    public void testBasicMapTypes() throws Exception {
        ...
        ReflectTypeState typeState = new ReflectTypeState();
        int start = typeState.getKnownTypes().size();
        TypeDefinition root = ReflectTypeUtils.getTypeDefinition(BasicMapTypes.class,
                typeState, false);
        ...
        assertEquals(typeState.getType("java.lang.String"),
                mtd.getKeyFieldDefinition().getTypeDefinition());
        assertEquals(typeState.getType("java.lang.String"),
                mtd.getValueFieldDefinition().getTypeDefinition());
    }
    
    public void NOTYETSUPPORTEDtestArrayNestedInList() throws Exception {

        TypeState typeState = new ReflectTypeState();
        TypeDefinition root = ReflectTypeUtils.getTypeDefinition(ArrayNestedInList.class,
                typeState, false);
        assertNotNull(root);
    }
    ...
    public void testListListMapType() throws Exception {
        ...
        ReflectTypeState typeState = new ReflectTypeState();
        int start = typeState.getKnownTypes().size();
        TypeDefinition root = ReflectTypeUtils.getTypeDefinition(ListSetMapType.class,
                typeState, false);
        ...
        assertEquals(List.class.getName(),
                complicatedField.getArrayTypes().get(0).getTypeName());
        assertEquals(Set.class.getName(),
                complicatedField.getArrayTypes().get(1).getTypeName());
        ...
        assertEquals(complicatedField.getArrayTypes().get(0),
                complicatedValueField.getArrayTypes().get(0));
    }
    
    public void testNestedMapType() throws Exception {

        ReflectTypeState typeState = new ReflectTypeState();
        TypeDefinition root = ReflectTypeUtils.getTypeDefinition(NestedMapType.class,
                typeState, false);
    ...
    public void testNoGetter() throws Exception {
        ...
        TypeState typeState = new ReflectTypeState();
        TypeDefinition root = ReflectTypeUtils.getTypeDefinition(NoGetter.class,
                typeState, false);
        ...
        assertEquals(String.class.getName(),
                otd.getFields().get("foo").getTypeDefinition().getTypeName());
    }
    
    public void testCyclicalType() throws Exception {
        
        TypeState typeState = new ReflectTypeState();
        TypeDefinition typeDefinition = ReflectTypeUtils.getTypeDefinition(
                Cyclical.class, typeState, false);
        ...
        assertEquals(otd,
                otd.getFields().get("cyclical").getTypeDefinition());
    }
    ...
    public void testFieldDefinition_ArrayTypes() throws Exception {
        ...
        ReflectTypeState typeState = new ReflectTypeState();
        int start = typeState.getKnownTypes().size();
        FieldDefinition fd = ReflectTypeUtils.getFieldDefinition(arr.getClass(),
    ...
    public void testFieldDefinition_getNull() throws Exception {
        ...
        TypeState typeState = new ReflectTypeState();
        FieldDefinition fd = ReflectTypeUtils.getFieldDefinition((Type) null,
                typeState, false, null);
        assertNotNull(fd);
    ...
    public void testListNoGenerics() throws Exception {
        ...
        TypeDefinition td = ReflectTypeUtils.getTypeDefinition(NoGenerics.class,
                new ReflectTypeState(), false);
        assertNotNull(td);
        ...
        assertEquals(List.class.getName(),
                fd.getArrayTypes().get(0).getTypeName());
        
        // strict mode, we get an error
        try {
            ReflectTypeUtils.getTypeDefinition(NoGenerics.class,
    ...
    public void testMapNoGenerics() throws Exception {
        ...
        // not strict, everything should work & we get a null type
        TypeDefinition td = ReflectTypeUtils.getTypeDefinition(MapNoGenerics.class,
                new ReflectTypeState(), false);
        assertNotNull(td);
        assertTrue(td instanceof ObjectTypeDefinition);
        ObjectTypeDefinition otd = (ObjectTypeDefinition) td;
        ...
        // strict mode, we get an error
        try {
            ReflectTypeUtils.getTypeDefinition(MapNoGenerics.class,
                    new ReflectTypeState(), true);
            fail("expected exception");
        } catch (WMRuntimeException e) {
            assertEquals(Resource.JSON_TYPE_NOGENERICS.getId(),
    ...
    public void testGetClasses() throws Exception {
        ...
        TypeDefinition td = ReflectTypeUtils.getTypeDefinition(WithClasses.class,
                new ReflectTypeState(), false);
        assertNotNull(td);
        assertTrue(td instanceof ObjectTypeDefinition);
        ObjectTypeDefinition otd = (ObjectTypeDefinition) td;
        ...
        assertEquals(Class.class,
                ((ReflectTypeDefinition)otd.getFields().get("klassQuestion").getTypeDefinition()).getKlass());
        assertEquals(Class.class,
                ((ReflectTypeDefinition)otd.getFields().get("klassString").getTypeDefinition()).getKlass());
        assertEquals(Class.class,
                ((ReflectTypeDefinition)otd.getFields().get("klassNothing").getTypeDefinition()).getKlass());
    }
    ...
    public void testGetFieldDefinitionDimensions() throws Exception {
        ...
        fd = ReflectTypeUtils.getFieldDefinition(foo.getClass(),
        ...
        fd = ReflectTypeUtils.getFieldDefinition(foo2.getClass(),
                new ReflectTypeState(), false, null);
        assertEquals(1, fd.getDimensions());
        assertNull(fd.getTypeDefinition());
        ...
        fd = ReflectTypeUtils.getFieldDefinition(foo3.getClass(),
                new ReflectTypeState(), false, "bar");
    ...
    public void testGetEnumTypeDefinition() throws Exception {
        ...
        TypeDefinition td = ReflectTypeUtils.getTypeDefinition(
                ClassWithEnum.class, typeState, false);
    ...
    public void testGetArrayParameterType() throws Exception {
        ...
        Method m = ArrayParameterTestClass.class.getMethod("getProperties", Object.class,
                String.class, ClassUtils.forName("java.lang.String[]"));
        assertNotNull(m);
        
        Type[] types = m.getGenericParameterTypes();
        assertEquals(3, types.length);
        
        FieldDefinition fd = ReflectTypeUtils.getFieldDefinition(types[2],
                new ReflectTypeState(), false, "arrProps");
        assertEquals(1, fd.getDimensions());
    ...
    public void testGetListArrayParameterType() throws Exception {
        ...
        Method m = ArrayParameterTestClass.class.getMethod("getProperties2", Object.class,
    ...
    public static class ArrayParameterTestClass {
        ...
        public ArrayList<Object> getProperties(Object session,
                String stepInstanceId, String[] arrProps) throws Exception {
            return null;
        }
        
        public ArrayList<Object> getProperties2(Object session,
                String stepInstanceId, List<String[]> arrProps) throws Exception {
            return null;
        }
    }
}