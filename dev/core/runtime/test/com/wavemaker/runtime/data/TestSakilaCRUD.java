...
public class TestSakilaCRUD extends RuntimeDataSpringContextTestCase {
    ...
    public static Test suite() {
        ...
        testsToRun.addTest(new TestSakilaCRUD("testConnection", data));

        testsToRun.addTest(new TestSakilaCRUD("testNoSanFrancisco", data));
        testsToRun.addTest(new TestSakilaCRUD("testGetStephens", data));
        testsToRun.addTest(new TestSakilaCRUD("testBlob", data));
        testsToRun.addTest(new TestSakilaCRUD("testAddStore", data));
        testsToRun.addTest(new TestSakilaCRUD("testNoSanFrancisco", data));

        testsToRun.addTest(new TestSakilaCRUD("testGetWoodridgeAddress", data));
        testsToRun.addTest(new TestSakilaCRUD("testAddCustomer", data));
        testsToRun.addTest(new TestSakilaCRUD("testCustomerInserted", data));
        testsToRun.addTest(new TestSakilaCRUD("testAddFilmAndInventory", data));

        testsToRun
                .addTest(new TestSakilaCRUD("testFilmInStockProcedure", data));
        testsToRun.addTest(new TestSakilaCRUD("testAddRental", data));
        testsToRun.addTest(new TestSakilaCRUD("testCustomerListView", data));
        testsToRun.addTest(new TestSakilaCRUD("testFilmListView", data));

        testsToRun.addTest(new TestSakilaCRUD("testDeleteFilmAndRental", data));
        testsToRun.addTest(new TestSakilaCRUD("testDeleteCustomer", data));

        testsToRun.addTest(new TestSakilaCRUD("testDeleteDetachedCity", data));

        testsToRun.addTest(new TestSakilaCRUD("testUpdateCity", data));

        testsToRun
                .addTest(new TestSakilaCRUD("testUpdateCityAndCountry", data));

        testsToRun.addTest(new TestSakilaCRUD("testSelectClause", data));
        testsToRun.addTest(new TestSakilaCRUD("testListBindParameter", data));

        testsToRun.addTest(new TestSakilaCRUD("testCascadeSave", data));
    ...
    public TestSakilaCRUD(String methodName, TestData data) {
        super(methodName);
        this.data = data;
    }
