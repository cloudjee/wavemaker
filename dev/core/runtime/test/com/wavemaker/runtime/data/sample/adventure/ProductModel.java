...
public class ProductModel  implements java.io.Serializable {
    ...
    public ProductModel(int productModelId, String name, Clob catalogDescription, String rowguid, Date modifiedDate, Set products, Set productModelProductDescriptions) {
       this.productModelId = productModelId;
       this.name = name;
