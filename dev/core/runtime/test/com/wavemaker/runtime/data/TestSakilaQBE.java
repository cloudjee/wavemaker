...
public class TestSakilaQBE extends RuntimeDataSpringContextTestCase {
    ...
    public static Test suite() {
        ...
        testsToRun.addTest(new TestSakilaQBE("testInitService", testData));

        testsToRun.addTest(new TestSakilaQBE("testOrderByRelated1", testData));
        testsToRun.addTest(new TestSakilaQBE("testOrderByRelated2", testData));
        testsToRun.addTest(new TestSakilaQBE("testGetAllActorsWithClass",
                testData));
        testsToRun.addTest(new TestSakilaQBE("testGetAllActorsWithInstance",
                testData));
        testsToRun.addTest(new TestSakilaQBE("testCityNameSearch", testData));
        testsToRun.addTest(new TestSakilaQBE("testCityByCountrySearch",
                testData));
        testsToRun.addTest(new TestSakilaQBE("testSubstringSearch", testData));
        testsToRun.addTest(new TestSakilaQBE("testToManySearch", testData));
        testsToRun.addTest(new TestSakilaQBE("testOrderBySimple", testData));
        testsToRun.addTest(new TestSakilaQBE("testGetActorsPaging", testData));
        testsToRun.addTest(new TestSakilaQBE("testSakilaServiceAutoPaging",
                testData));

        testsToRun.addTest(new TestSakilaQBE("testSearchById", testData));
        testsToRun.addTest(new TestSakilaQBE("testSearchById2", testData));
        testsToRun.addTest(new TestSakilaQBE("testSearchById3", testData));
        testsToRun.addTest(new TestSakilaQBE("testSearchById4", testData));
        testsToRun.addTest(new TestSakilaQBE("testSearchByCompositeId2",
                testData));

        testsToRun.addTest(new TestSakilaQBE("testMAV101", testData));

        testsToRun.addTest(new TestSakilaQBE("testSearchOnTwoForeignKeys",
                testData));

        testsToRun.addTest(new TestSakilaQBE("testLoadCityAndAddresses",
                testData));
        testsToRun
                .addTest(new TestSakilaQBE("testLoadCityAndCountry", testData));

        testsToRun.addTest(new TestSakilaQBE("testSqlRestrictionWhereClause",
                testData));
    ...
    public TestSakilaQBE(String testMethod, TestData testData) {
        super(testMethod);
