...
public class Product  implements java.io.Serializable {
    ...
    public Product(int productId, String name, String productNumber, BigDecimal standardCost, BigDecimal listPrice, Date sellStartDate, String rowguid, Date modifiedDate) {
    ...
    public Product(int productId, ProductCategory productCategory, ProductModel productModel, String name, String productNumber, String color, BigDecimal standardCost, BigDecimal listPrice, String size, BigDecimal weight, Date sellStartDate, Date sellEndDate, Date discontinuedDate, Blob thumbNailPhoto, String thumbnailPhotoFileName, String rowguid, Date modifiedDate, Set salesOrderDetails) {
       this.productId = productId;
