...
public class SalesOrderDetailId  implements java.io.Serializable {
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof SalesOrderDetailId) ) return false;
		 SalesOrderDetailId castOther = ( SalesOrderDetailId ) other; 
         
		 return (this.getSalesOrderId()==castOther.getSalesOrderId())
 && (this.getSalesOrderDetailId()==castOther.getSalesOrderDetailId());
   }
