...
public class TestDataServiceUtils extends RuntimeDataSpringContextTestCase {
    ...
    public static Test suite() {
        ...
        testsToRun.addTest(new TestDataServiceUtils("testConnection", data));
        testsToRun.addTest(new TestDataServiceUtils("testReloadById", data));
        testsToRun.addTest(new TestDataServiceUtils(
                "testMergeForUpdateSimpleProperties", data));
        testsToRun.addTest(new TestDataServiceUtils(
                "testMergeForUpdateRelatedProperty", data));
    ...
    public TestDataServiceUtils(String methodName, TestData data) {
        setName(methodName);
        this.data = data;
    }
