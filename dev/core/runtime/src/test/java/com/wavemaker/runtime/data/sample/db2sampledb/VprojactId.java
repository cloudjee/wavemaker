...
public class VprojactId  implements java.io.Serializable {
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof VprojactId) ) return false;
 ...
 && ( (this.getAcstaff()==castOther.getAcstaff()) || ( this.getAcstaff()!=null && castOther.getAcstaff()!=null && this.getAcstaff().equals(castOther.getAcstaff()) ) )
 && ( (this.getAcstdate()==castOther.getAcstdate()) || ( this.getAcstdate()!=null && castOther.getAcstdate()!=null && this.getAcstdate().equals(castOther.getAcstdate()) ) )
 && ( (this.getAcendate()==castOther.getAcendate()) || ( this.getAcendate()!=null && castOther.getAcendate()!=null && this.getAcendate().equals(castOther.getAcendate()) ) );
   }
