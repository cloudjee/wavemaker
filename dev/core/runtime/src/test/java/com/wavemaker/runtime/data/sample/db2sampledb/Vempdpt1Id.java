...
public class Vempdpt1Id  implements java.io.Serializable {
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof Vempdpt1Id) ) return false;
 ...
 && ( (this.getWorkdept()==castOther.getWorkdept()) || ( this.getWorkdept()!=null && castOther.getWorkdept()!=null && this.getWorkdept().equals(castOther.getWorkdept()) ) );
   }
