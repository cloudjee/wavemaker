...
public class TestElementType extends WMTestCase {
    ...
    public void testPropertyFromClass() throws Exception {
        ...
        assertEquals("com.wavemaker.runtime.service.TestElementType",
                et.getJavaType());
        ...
        for (ElementType prop: et.getProperties()) {
            if (prop.getName().equals("stringList")) {
                ...
                prop.setRequire(CollectionUtils.createList(
                        OperationEnumeration.read,
                        OperationEnumeration.update,
                        OperationEnumeration.delete));
                prop.setExclude(CollectionUtils.createList(
                        OperationEnumeration.insert));
                prop.setNoChange(CollectionUtils.createList(
                        OperationEnumeration.update));
    ...
    protected void checkAttributes(ElementType prop, FieldDefinition field) {
        ...
        assertEquals(prop.isSupportsQuickData(),
                field.getTypeDefinition().isLiveService());
