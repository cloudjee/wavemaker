...
public class ThreadContext {
    ...
    private static ThreadLocal<Task> preProcessorTask =
        new ThreadLocal<Task>();

    private static ThreadLocal<HashMap<String, Context>> threadLocal =
    ...
    public static Context getContext(String dbName) {
        ...
        if (contextHash == null || contextHash.size() == 0) return null;
    ...
    public static HashMap<String, Context> getThreadLocalHash() {
     ...
     public static class Context {
         ...
         public Context(PlatformTransactionManager txMgr, 
                        ...
                        SessionFactory fac) 
         {
             ...
             HashMap <String, Context> contextHash = threadLocal.get();
             if (contextHash == null) contextHash = new HashMap<String, Context>();
