...
public class HbmConstants {
    ...
    public static final String FQ_GEN_PARAM_NAME_ATTR = fq(GEN_PARAM_EL,
            NAME_ATTR);
    ...
    public static final String FQ_COL_PRECISION_ATTR = fq(COL_EL,
            PRECISION_ATTR);
    ...
    public static final Collection<String> PROP_WRAPPER_ELS = new HashSet<String>(
            2);
    static {
