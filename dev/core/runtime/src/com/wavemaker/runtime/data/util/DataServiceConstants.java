...
public class DataServiceConstants {
    ...
    public static final String GENERATE_OLD_STYLE_OPRS_PROPERTY = 
    ...
    public static final String DEFAULT_QUERY_STORE = DESIGN_ANNO_CHAR
            + "default-queries";

    public static final String GENERATED_QUERY = DESIGN_ANNO_CHAR + "generated";

    public static final String HIBERNATE_USER_PROPERTY = 
        "hibernate.connection.username";

    public static final String HIBERNATE_PASS_PROPERTY = 
        "hibernate.connection.password";

    public static final String HIBERNATE_DRIVER_CLASS_NAME_PROPERTY = 
        "hibernate.connection.driver_class";

    public static final String HIBERNATE_CONNECTION_URL_PROPERTY = 
        "hibernate.connection.url";

    public static final String HIBERNATE_DIALECT_PROPERTY = 
        "hibernate.dialect";
    ...
    public static final String OLD_SESSION_FACTORY_CLASS_NAME = 
        "com.activegrid.runtime.data.spring.AGLocalSessionFactoryBean";

    public static final String OLD_SPRING_DATA_SERVICE_MANAGER_NAME = 
        "com.activegrid.runtime.data.spring.SpringDataServiceManager";
    
    public static final String OLD_TASK_MANAGER_NAME = 
        "com.activegrid.runtime.data.DefaultTaskManager";
