 ...
 * objects, and other WaveMaker interfaces. This is the primary interface point
 * for any WaveMaker system access.
 * 
 ...
 * more information). The AGRuntime bean is named runtime, an example:
 * 
 * <pre>
 ...
 * @version $Rev$ - $Date$
 * 
 * @deprecated AGRuntime is now deprecated; instead, use {@link RuntimeAccess}.
 *             In a future release, AGRuntime will be removed.  Also, note that
 *             {@link RuntimeAccess} uses a different bean name (runtimeAccess).
 * 
 */
@Deprecated
public class AGRuntime {
    ...
    /**
     * Statically return the current instance of AGRuntime. This depends on the
    ...
    public static AGRuntime getInstance() {
        ...
        if (null==AGRuntime.staticRuntime) {
            throw new WMRuntimeException(
                    "AGRuntime uninitialized; request init failed.");
        }
    ...
    /**
     * Get the service (of the corresponding serviceType). An AGRuntimeException
