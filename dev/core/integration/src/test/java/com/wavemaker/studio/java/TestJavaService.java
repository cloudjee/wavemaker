...
public class TestJavaService extends StudioTestCase {
    ...
    @Test public void testNewService() throws Exception {
    ...
    @Test public void testDuplicateNewService() throws Exception {
    ...
    @Test public void testNewServicePackage() throws Exception {
    ...
    @Test public void testSaveOpen() throws Exception {
    ...
    @Test public void testNewSaveSimple() throws Exception {
    ...
    @Test public void testJarType() throws Exception {
    ...
    @Test public void testBadId() throws Exception {
    ...
    @Test public void testBadJava() throws Exception {
     ...
     */
    @Test public void testBadJavaNoClassFile() throws Exception {
    ...
    @Test public void testExcludeOtherServicesTypes() throws Exception {
    ...
    // MAV-1360 - repro case
    @Test public void testNewServiceWithVariables() throws Exception {
