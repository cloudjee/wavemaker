...
public class TestClientSideRefactorUpgrade extends StudioTestCase {
    ...
    public void test_1_IndexRename() throws Exception {
        ...
        File indexhtml = new File(p.getWebAppRoot().getFile(), ProjectConstants.INDEX_HTML);
        File bakIndexhtml = new File(indexhtml.getAbsolutePath() + "." + ClientSideRefactorUpgrade.BACKUP_EXT);
    ...
    public void test_2_RemoveWM__3_WidgetNameChanges__4__8() throws Exception {
        ...
        File maingridWidgetsJS = new File(p.getWebAppRoot().getFile(), "pages/MainGrid/MainGrid.widgets.js");
        assertTrue(maingridWidgetsJS.exists());
        assertEquals(StringUtils.deleteWhitespace(this.MainGrid_widgets_expected_2),
            StringUtils.deleteWhitespace(FileUtils.readFileToString(maingridWidgetsJS)));
        File maingridJS = new File(p.getWebAppRoot().getFile(), "pages/MainGrid/MainGrid.js");
        assertFalse(maingridJS.exists());

        File editpageWidgetsJS = new File(p.getWebAppRoot().getFile(), "pages/EditPage/EditPage.widgets.js");
        assertFalse(editpageWidgetsJS.exists());
        File editpageJS = new File(p.getWebAppRoot().getFile(), "pages/EditPage/EditPage.js");
        assertTrue(editpageJS.exists());
        assertEquals(this.EditPage_js_expected_2, FileUtils.readFileToString(editpageJS));
    }
    ...
    public void test_4() throws Exception {
        ...
        File mainWidgetsJS = new File(p.getWebAppRoot().getFile(), "pages/Main/Main.widgets.js");
        assertTrue(mainWidgetsJS.exists());
        assertEquals(this.expected_4, FileUtils.readFileToString(mainWidgetsJS));
    }
    ...
    public void test_5_TrimTypes() throws Exception {
        ...
        File appJS = new File(p.getWebAppRoot().getFile(), p.getProjectName() + ".js");
        assertTrue(appJS.exists());
        String actual = FileUtils.readFileToString(appJS);
        assertEquals(this.app_js_expectedFor_5, actual);
    }
    ...
    public void test_7() throws Exception {
        ...
        File mainWidgetsJS = new File(p.getWebAppRoot().getFile(), "pages/Main/Main.widgets.js");
        assertTrue(mainWidgetsJS.exists());
        assertEquals(StringUtils.deleteWhitespace(this.expected_7), StringUtils.deleteWhitespace(FileUtils.readFileToString(mainWidgetsJS)));
    }
    ...
    public void testOrdering() throws Exception {
        ...
        File mainWidgetsJS = new File(p.getWebAppRoot().getFile(), "pages/Main/Main.widgets.js");
        assertTrue(mainWidgetsJS.exists());
        assertEquals(StringUtils.deleteWhitespace(this.expected_Ordering), StringUtils.deleteWhitespace(FileUtils.readFileToString(mainWidgetsJS)));
    }
    ...
    public void testUpgradeExpression() throws Exception {
        ...
        assertEquals("\\\"foo\\\"", ClientSideRefactorUpgrade.upgradeExpression("foo"));
        assertEquals("Number(12)", ClientSideRefactorUpgrade.upgradeExpression("%%12"));
        assertEquals("Boolean(true)", ClientSideRefactorUpgrade.upgradeExpression("^^true"));
    }
    ...
    public void testPanePagePattern() throws Exception {
        ...
        assertEquals("rue, operation: \"gotoPageContainerPage\", \"servi", matcher.replaceAll(csru.panePageReplaceStr));

        sample = sample + sample;
        matcher = csru.panePagePattern.matcher(sample);
        assertEquals("rue, operation: \"gotoPageContainerPage\", \"servi" + "rue, operation: \"gotoPageContainerPage\", \"servi",
            matcher.replaceAll(csru.panePageReplaceStr));

        sample = "\"wm.Variable\", {type: \"gotoPanePageInputs\"}, {}, {";
        matcher = csru.panePagePattern.matcher(sample);
        assertTrue(matcher.find());
        assertEquals("\"wm.Variable\", {type: \"gotoPageContainerPageInputs\"}, {}, {", matcher.replaceAll(csru.panePageReplaceStr));
    }
    ...
    public void testPanePattern() throws Exception {
        ...
        String sample = sampleStartPrefix + sampleStart + "pane" + sampleEnd + sampleEndPostfix;
        ;
        ...
        assertEquals(sampleStartPrefix + sampleStart + "foo" + sampleEnd + sampleEndPostfix, matcher.replaceAll("$1foo$2"));
        assertEquals(sampleStartPrefix + sampleStart + "pageContainer" + sampleEnd + sampleEndPostfix, matcher.replaceAll(csru.paneReplaceStr));

        matcher = csru.panePattern.matcher(sample + sample);
        assertEquals(sampleStartPrefix + sampleStart + "pageContainer" + sampleEnd + sampleEndPostfix + sampleStartPrefix + sampleStart
            + "pageContainer" + sampleEnd + sampleEndPostfix, matcher.replaceAll(csru.paneReplaceStr));
    }
    ...
    public void testServiceInputVariablePattern() throws Exception {
        ...
        assertTrue(matcher.find());
        assertEquals(expected, matcher.replaceAll(csru.serviceInputVariableReplaceStr));
    }
    ...
    private void populateFor_2(Project p) throws Exception {
        ...
        File pagesdir = new File(p.getWebAppRoot().getFile(), ProjectConstants.PAGES_DIR);
        if (!pagesdir.exists()) {
            pagesdir.mkdir();
        }
        ...
        FileUtils.writeStringToFile(editpageJS, this.EditPage_js_input);

        File maingrid = new File(pagesdir, "MainGrid");
        maingrid.mkdir();
        File maingridWidgetsJS = new File(maingrid, "MainGrid.widgets.js");
        FileUtils.writeStringToFile(maingridWidgetsJS, this.MainGrid_widgets_input);
    }
    ...
    private void populateFor_4(Project p) throws Exception {
        ...
        FileUtils.writeStringToFile(editpageJS, this.input_4);
    }
    ...
    private void populateFor_5(Project p) throws Exception {
        ...
        FileUtils.writeStringToFile(appJS, this.app_js_inputFor_5);
    }
    ...
    private void populateFor_7(Project p) throws Exception {
        ...
        editpage.mkdir();
        File editpageJS = new File(editpage, "Main.widgets.js");
        FileUtils.writeStringToFile(editpageJS, this.input_7);
    }
    ...
    private void populateFor_Ordering(Project p) throws Exception {
        ...
        editpage.mkdir();
        File editpageJS = new File(editpage, "Main.widgets.js");
        FileUtils.writeStringToFile(editpageJS, this.input_Ordering);
    }
}