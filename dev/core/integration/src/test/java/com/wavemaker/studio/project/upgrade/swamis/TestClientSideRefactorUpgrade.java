...
public class TestClientSideRefactorUpgrade extends StudioTestCase {
    ...
    @Test public void test_1_IndexRename() throws Exception {
        
        makeProject("test_1_IndexRename", false);
        Project p = ((ProjectManager)getBean("projectManager")).getCurrentProject();
        populateFor_1(p);
        
        File indexhtml = new File(p.getWebAppRoot(), ProjectConstants.INDEX_HTML);
    ...
    @Test public void test_2_RemoveWM__3_WidgetNameChanges__4__8() throws Exception {
        ...
        File maingridWidgetsJS = new File(p.getWebAppRoot(), "pages/MainGrid/MainGrid.widgets.js");
        ...
        File maingridJS = new File(p.getWebAppRoot(), "pages/MainGrid/MainGrid.js");
        assertFalse(maingridJS.exists());

        File editpageWidgetsJS = new File(p.getWebAppRoot(), "pages/EditPage/EditPage.widgets.js");
        assertFalse(editpageWidgetsJS.exists());
        File editpageJS = new File(p.getWebAppRoot(), "pages/EditPage/EditPage.js");
        assertTrue(editpageJS.exists());
        assertEquals(EditPage_js_expected_2, FileUtils.readFileToString(editpageJS));
    }
    ...
    @Test public void test_4() throws Exception {
        ...
        File mainWidgetsJS = new File(p.getWebAppRoot(), "pages/Main/Main.widgets.js");
        assertTrue(mainWidgetsJS.exists());
        assertEquals(expected_4,
                FileUtils.readFileToString(mainWidgetsJS));
    }

    @Test public void test_5_TrimTypes() throws Exception {
        ...
        File appJS = new File(p.getWebAppRoot(), p.getProjectName()+".js");
    ...
    @Test public void test_7() throws Exception {
        ...
        assertEquals(StringUtils.deleteWhitespace(expected_7),
                StringUtils.deleteWhitespace(FileUtils.readFileToString(mainWidgetsJS)));
    }
    ...
    @Test public void testTrimOutTypes() throws Exception {
    ...
    @Test public void testUpgradeExpression() throws Exception {
    ...
    @Test public void testPanePagePattern() throws Exception {
    ...
    @Test public void testPanePattern() throws Exception {
        ...
        assertEquals(sampleStartPrefix + sampleStart + "pageContainer"
                + sampleEnd + sampleEndPostfix, matcher
                .replaceAll(csru.paneReplaceStr));
    ...
    @Test public void testServiceInputVariablePattern() throws Exception {
    ...
    private void populateFor_1(Project p) throws Exception {
        populateProject(p.getProjectRoot());
    }
