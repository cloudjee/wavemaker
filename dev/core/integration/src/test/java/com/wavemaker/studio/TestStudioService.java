...
public class TestStudioService extends StudioTestCase {
	...
	public void testNewProject() throws Exception {
		...
		try {
			...
			String[] o = (String[]) invokeService_toObject("studioService",
					"listProjects", null);
			System.out.println("test 5:" + o.getClass().getName());
			assertTrue(o instanceof String[]);
			assertEquals("testNewProject", o[0]);
			makeProject("a");
			o = (String[]) invokeService_toObject("studioService",
					"listProjects", null);
			assertEquals("a", o[0]);
			...
			/*
			 * assertTrue(o instanceof Set); assertEquals("testNewProject",
			 * ((Set<?>) o).iterator().next()); makeProject("a"); o =
			 * invokeService_toObject("studioService", "listProjects", null);
			 * assertTrue(o instanceof Set); Iterator<?> it =
			 * ((Set<?>)o).iterator(); assertEquals("a", it.next());
			 * assertEquals("testNewProject", it.next()); makeProject("d");
			 * makeProject("c"); o = invokeService_toObject("studioService",
			 * "listProjects", null); assertTrue(o instanceof Set); it =
			 * ((Set<?>)o).iterator(); assertEquals("a", it.next());
			 * 
			 * assertEquals("c", it.next()); assertEquals("d", it.next());
	...
	public void testNewProject2() throws Exception {
		...
		File expectedPath = new File(new File(getTestWaveMakerHome(),
				LocalStudioConfiguration.PROJECTS_DIR), projectName2);
	...
	public void testWriteReadExistsFile() throws Exception {
		...
		invokeService_toObject("studioService", "writeFile", new Object[] {
				"writefile.data", data });

		b = (Boolean) invokeService_toObject("studioService", "fileExists",
				new Object[] { "writefile.data" });
		assertTrue(b);
		...
		Object o = invokeService_toObject("studioService", "readFile",
				new Object[] { "writefile.data" });
		assertEquals(data, o);
	}
	...
	public void testClobber() throws Exception {
		...
		invokeService_toObject("studioService", "writeFile", new Object[] {
				"writefile.data", data2, true });
		Object ret = invokeService_toObject("studioService", "readFile",
				new Object[] { "writefile.data" });
		assertEquals(data, ret);

		invokeService_toObject("studioService", "writeFile", new Object[] {
				"writefile.data", data2, false });
		ret = invokeService_toObject("studioService", "readFile",
				new Object[] { "writefile.data" });
		...
		invokeService_toObject("studioService", "writeWebFile", new Object[] {
				"writefile.data", data });

		invokeService_toObject("studioService", "writeWebFile", new Object[] {
				"writefile.data", data2, true });
		ret = invokeService_toObject("studioService", "readWebFile",
				new Object[] { "writefile.data" });
		assertEquals(data, ret);
	...
	public void testReadObjectSpringConfigFile() throws Exception {
		...
		Object o = invokeService_toObject("studioService", "readObject",
				new Object[] { "config/spring.xml" });

		assertTrue("o: " + o + " (" + o.getClass() + ")",
	...
	public void testReadFileSpringConfigFile() throws Exception {
		...
		String original = FileUtils
				.readFileToString(new File(projectDir, path));
	...
	public void testWriteReadWebFile() throws Exception {
		...
		Object o = invokeService_toObject("studioService", "writeWebFile",
				new Object[] { sendPath, sendData });
		assertNull(o);

		File expected = new File(new File(new File(new File(
				getTestWaveMakerHome(), LocalStudioConfiguration.PROJECTS_DIR),
				projectName), ProjectConstants.WEB_DIR), sendPath);
		assertTrue(expected.exists());
		assertEquals(sendData, FileUtils.readFileToString(expected));

		o = invokeService_toObject("studioService", "readWebFile",
				new Object[] { sendPath });
		assertTrue(o instanceof String);
		assertEquals(sendData, o);

		o = invokeService_toObject("studioService", "getWebPath",
				new Object[] {});
	...
	public void testDeleteProject() throws Exception {
		...
		invokeService_toObject("studioService", "deleteProject",
	...
	public void testGetSetPreferences() throws Exception {
		...
		Map<String, String> prefs = CastUtils
				.cast((Map<?, ?>) invokeService_toObject("studioService",
						"getPreferences", new Object[] {}));
		...
		assertEquals(wmHome.getAbsolutePath(),
				prefs.get(LocalStudioConfiguration.WMHOME_KEY));
		if (demoDir == null)
		...
		if ("cloud".equals(PROJECT_TYPE)) {
			...
			assertEquals(demoDir.getAbsolutePath(),
					prefs.get(LocalStudioConfiguration.DEMOHOME_KEY));
		}
		...
		try {
			prefs.put(LocalStudioConfiguration.WMHOME_KEY,
					newDir.getAbsolutePath());
			System.out.println("TEST GETSET 13");
			invokeService_toObject("studioService", "setPreferences",
					new Object[] { prefs });
			...
			if ("cloud".equals(PROJECT_TYPE)) {
				...
				System.out.println("TEST GETSET 14.3:"
						+ (LocalStudioConfiguration.WMHOME_KEY == null));
				System.out
						.println("TEST GETSET 14.4:"
								+ (prefs.get(LocalStudioConfiguration.WMHOME_KEY == null)));
				prefs = CastUtils.cast((Map<?, ?>) invokeService_toObject(
				...
				assertEquals(newDir.getAbsolutePath(),
						ConfigurationStore.getPreference(
								LocalStudioConfiguration.class,
								LocalStudioConfiguration.WMHOME_KEY, null));
			}
