...
public class TestStudioService extends StudioTestCase {
    ...
    public void testNewProject() throws Exception {
        ...
        try {
            ...
            String[] o = (String[]) invokeService_toObject("studioService", "listProjects", null);
            System.out.println("test 5:" + o.getClass().getName());
            assertTrue(o instanceof String[]);
            assertEquals("testNewProject", o[0]);
            makeProject("a");
            o = (String[]) invokeService_toObject("studioService", "listProjects", null);
            assertEquals("a", o[0]);
            ...
            /*
             * assertTrue(o instanceof Set); assertEquals("testNewProject", ((Set<?>) o).iterator().next());
             * makeProject("a"); o = invokeService_toObject("studioService", "listProjects", null); assertTrue(o
             * instanceof Set); Iterator<?> it = ((Set<?>)o).iterator(); assertEquals("a", it.next());
             * assertEquals("testNewProject", it.next()); makeProject("d"); makeProject("c"); o =
             * invokeService_toObject("studioService", "listProjects", null); assertTrue(o instanceof Set); it =
             * ((Set<?>)o).iterator(); assertEquals("a", it.next());
             * 
             * assertEquals("c", it.next()); assertEquals("d", it.next()); assertEquals("testNewProject", it.next());
             */
    ...
    @Test
    public void testOpenUpgradeProject() throws Exception {
        ...
        try {
            ...
            Object o = invokeService_toObject("studioService", "openProject", new Object[] { p.getProjectName() });
    ...
    @Test
    public void testNewProject2() throws Exception {

        String projectName2 = "testNewProject2";
        File expectedPath = new File(new File(getTestWaveMakerHome(), LocalStudioConfiguration.PROJECTS_DIR), projectName2);
        assertFalse(expectedPath.exists());

        Object o = invokeService_toObject("studioService", "newProject", new Object[] { projectName2 });

        assertTrue(expectedPath.exists());

        Object getWebPathRet = invokeService_toObject("studioService", "getWebPath", null);

        assertEquals(getWebPathRet, o);
    }

    @Test
    public void testWriteReadExistsFile() throws Exception {

        String data = "hihihi";

        makeProject("testWriteStringFile");

        Boolean b = (Boolean) invokeService_toObject("studioService", "fileExists", new Object[] { "writefile.data" });
        assertFalse(b);

        invokeService_toObject("studioService", "writeFile", new Object[] { "writefile.data", data });

        b = (Boolean) invokeService_toObject("studioService", "fileExists", new Object[] { "writefile.data" });
        assertTrue(b);

        File expected = new File(new File(getTestWaveMakerHome(), LocalStudioConfiguration.PROJECTS_DIR), "testWriteStringFile/writefile.data");
        ...
        Object o = invokeService_toObject("studioService", "readFile", new Object[] { "writefile.data" });
        assertEquals(data, o);
    }
    ...
    public void testClobber() throws Exception {
        ...
        invokeService_toObject("studioService", "writeFile", new Object[] { "writefile.data", data2, true });
        Object ret = invokeService_toObject("studioService", "readFile", new Object[] { "writefile.data" });
        assertEquals(data, ret);

        invokeService_toObject("studioService", "writeFile", new Object[] { "writefile.data", data2, false });
        ret = invokeService_toObject("studioService", "readFile", new Object[] { "writefile.data" });
        ...
        invokeService_toObject("studioService", "writeWebFile", new Object[] { "writefile.data", data });

        invokeService_toObject("studioService", "writeWebFile", new Object[] { "writefile.data", data2, true });
        ret = invokeService_toObject("studioService", "readWebFile", new Object[] { "writefile.data" });
        assertEquals(data, ret);

        invokeService_toObject("studioService", "writeWebFile", new Object[] { "writefile.data", data2, false });
        ret = invokeService_toObject("studioService", "readWebFile", new Object[] { "writefile.data" });
        assertEquals(data2, ret);
    ...
    @Test
    public void testReadObjectSpringConfigFile() throws Exception {

        File projectDir = makeProject("testReadSpringConfigFile");
        makeSpringConfig(projectDir);

        Object o = invokeService_toObject("studioService", "readObject", new Object[] { "config/spring.xml" });
        ...
        for (Object elem : ja) {
            ...
            if ("book1".equals(jelem.get("id"))) {
                assertEquals("com.wavemaker.tools.spring.Book", jelem.get("clazz"));
            }
        }
    }

    @Test
    public void testReadFileSpringConfigFile() throws Exception {
        ...
        String s = (String) invokeService_toObject("studioService", "readFile", new Object[] { path });

        assertEquals(original.trim(), s.trim());
    }

    @Test
    public void testWriteReadWebFile() throws Exception {
        ...
        Object o = invokeService_toObject("studioService", "writeWebFile", new Object[] { sendPath, sendData });
        assertNull(o);

        File expected = new File(new File(new File(new File(getTestWaveMakerHome(), LocalStudioConfiguration.PROJECTS_DIR), projectName),
            ProjectConstants.WEB_DIR), sendPath);
        assertTrue(expected.exists());
        assertEquals(sendData, FileUtils.readFileToString(expected));

        o = invokeService_toObject("studioService", "readWebFile", new Object[] { sendPath });
        assertTrue(o instanceof String);
        assertEquals(sendData, o);

        o = invokeService_toObject("studioService", "getWebPath", new Object[] {});
    ...
    public void testDeleteProject() throws Exception {
        ...
        invokeService_toObject("studioService", "deleteProject", new Object[] { projectName });
    ...
    public void testGetSetPreferences() throws Exception {
        ...
        File wmHome = sc.getWaveMakerHome().getFile();
        System.out.println("TEST GETSET 3");
        File demoDir = sc.getDemoDir().getFile();
        System.out.println("TEST GETSET 4");
        Map<String, String> prefs = CastUtils.cast((Map<?, ?>) invokeService_toObject("studioService", "getPreferences", new Object[] {}));
        System.out.println("TEST GETSET 5");
        assertTrue(prefs.containsKey(LocalStudioConfiguration.WMHOME_KEY));
        System.out.println("TEST GETSET 6");
        assertEquals(wmHome.getAbsolutePath(), prefs.get(LocalStudioConfiguration.WMHOME_KEY));
        if (demoDir == null) {
        ...
        if ("cloud".equals(PROJECT_TYPE)) {
            ...
            assertEquals(demoDir.getAbsolutePath(), prefs.get(LocalStudioConfiguration.DEMOHOME_KEY));
        }
        ...
        try {
            prefs.put(LocalStudioConfiguration.WMHOME_KEY, newDir.getAbsolutePath());
            System.out.println("TEST GETSET 13");
            invokeService_toObject("studioService", "setPreferences", new Object[] { prefs });
            ...
            if ("cloud".equals(PROJECT_TYPE)) {
                ...
                System.out.println("TEST GETSET 14.3:" + (LocalStudioConfiguration.WMHOME_KEY == null));
                System.out.println("TEST GETSET 14.4:" + prefs.get(LocalStudioConfiguration.WMHOME_KEY == null));
                ...
                assertEquals(newDir.getAbsolutePath(),
                    ConfigurationStore.getPreference(LocalStudioConfiguration.class, LocalStudioConfiguration.WMHOME_KEY, null));
            }
    ...
    @Test
    public void testGetStudioProjectType() throws Exception {

        Object o = invokeService_toObject("studioService", "getStudioProjectType", null);
        assertTrue(o instanceof String);
        String s = (String) o;
