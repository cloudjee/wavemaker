...
public class TestStaticFileController extends StudioTestCase {
    ...
    public void testGetFile() throws Exception {
        ...
        MockHttpServletRequest mhr = new MockHttpServletRequest("GET", "/servletname/projects/" + projectName + "/index.html");
        MockHttpServletResponse mhresp = new MockHttpServletResponse();

        StaticFileController sc = (StaticFileController) getApplicationContext().getBean("agStaticFileController");
        ModelAndView mav = sc.handleRequest(mhr, mhresp);
        assertNull(mav);

        assertEquals(FileUtils.readFileToString(indexHtml), mhresp.getContentAsString());
        assertEquals(HttpServletResponse.SC_OK, mhresp.getStatus());
        assertEquals("text/html", mhresp.getContentType());

        mhr = new MockHttpServletRequest("GET", "/servletname/projects/" + projectName + "/foo.smd");
        mhresp = new MockHttpServletResponse();
        mav = sc.handleRequest(mhr, mhresp);
        assertNull(mav);

        assertEquals(FileUtils.readFileToString(fooSmd), mhresp.getContentAsString());
        assertEquals(HttpServletResponse.SC_OK, mhresp.getStatus());
    ...
    public void testProjectList() throws Exception {
        ...
        MockHttpServletRequest mhr = new MockHttpServletRequest("GET", "/servletname/projects/");
        MockHttpServletResponse mhresp = new MockHttpServletResponse();
    ...
    public void testGetDirList() throws Exception {
        ...
        MockHttpServletRequest mhr = new MockHttpServletRequest("GET", "/servletname/projects/" + projectName + "/");
        MockHttpServletResponse mhresp = new MockHttpServletResponse();
        ...
        mhr = new MockHttpServletRequest("GET", "/servletname/projects/" + projectName);
        mhresp = new MockHttpServletResponse();
        sc.handleRequest(mhr, mhresp);
    ...
    public void testNoFile() throws Exception {
        ...
        MockHttpServletRequest mhr = new MockHttpServletRequest("GET", "/servletname/projects/" + projectName + "/dne.html");
        MockHttpServletResponse mhresp = new MockHttpServletResponse();
    ...
    public void testGetCSSFile() throws Exception {
        ...
        MockHttpServletRequest mhr = new MockHttpServletRequest("GET", "/servletname/projects/" + projectName + "/foo.css");
        MockHttpServletResponse mhresp = new MockHttpServletResponse();
    ...
    public void testBadTopLevel() throws Exception {
        ...
        MockHttpServletRequest mhr = new MockHttpServletRequest("GET", "/servletname/foobar/bar.html");
        MockHttpServletResponse mhresp = new MockHttpServletResponse();
        ...
        try {
            ...
            assertEquals(MessageResource.STUDIO_UNKNOWN_LOCATION.getId(), e.getMessageId());
        }
    }
    ...
    public void testWmGetFile() throws Exception {
        ...
        StudioConfiguration config = (StudioConfiguration) getApplicationContext().getBean("studioConfiguration");

        assertTrue(config.getWaveMakerHome().exists());
        config.getCommonDir().getFile().mkdir();
        File testFile = config.getCommonDir().createRelative("foo.widgets.js").getFile();
        String testFileContents = "widgets = []";
        FileUtils.writeStringToFile(testFile, testFileContents);

        MockHttpServletRequest mhr = new MockHttpServletRequest("GET", "/servletname/lib/wm/common/foo.widgets.js");
        MockHttpServletResponse mhresp = new MockHttpServletResponse();
        ...
        mhr = new MockHttpServletRequest("GET", "/servletname/lib/wm/common/fooDNE");
        mhresp = new MockHttpServletResponse();
        sc.handleRequest(mhr, mhresp);
    ...
    public void testWmGetDirList() throws Exception {
        ...
        LocalStudioConfiguration config = (LocalStudioConfiguration) getApplicationContext().getBean("studioConfiguration");
        config.getCommonDir().getFile().mkdir();
        File testFile = config.getCommonDir().createRelative("foo.widgets.js").getFile();
        String testFileContents = "widgets = []";
        FileUtils.writeStringToFile(testFile, testFileContents);

        MockHttpServletRequest mhr = new MockHttpServletRequest("GET", "/servletname/lib/wm/common/");
        MockHttpServletResponse mhresp = new MockHttpServletResponse();
        ...
        String response = mhresp.getContentAsString();
        assertTrue("response: " + response.toString(), response.contains("foo.widgets.js"));
