...
public class TestStaticFileController extends StudioTestCase {
    ...
    @Test public void testGetFile() throws Exception {
        ...
        File webapproot = project.getWebAppRoot();
        ...
        ModelAndView mav = sc.handleRequest(mhr,
                mhresp);
        assertNull(mav);
        ...
        mhr = new MockHttpServletRequest("GET",
                "/servletname/projects/" + projectName + "/foo.smd");
    ...
    @Test public void testProjectList() throws Exception {
    ...
    @Test public void testProjectListNoTrailingSlash() throws Exception {
    ...
    @Test public void testGetDirList() throws Exception {
    ...
    @Test public void testNoFile() throws Exception {
    ...
    @Test public void testGetCSSFile() throws Exception {
    ...
    @Test public void testBadTopLevel() throws Exception {
        ...
        try {
            ...
            assertEquals(Resource.STUDIO_UNKNOWN_LOCATION.getId(),
                    e.getMessageId());
        }
    }
    
    @Test public void testWmGetFile() throws Exception {
        ...
        config.getCommonDir().mkdir();
        File testFile = new File(config.getCommonDir(), "foo.widgets.js");
    ...
    @Test public void testWmGetDirList() throws Exception {
    ...
    // MAV-1857
    @Test public void testGetCaseSensitive_ProjectFiles() throws Exception {

        String projectName = "testGetCaseSensitiveFiles";
        makeProject(projectName);
        Project project = pm.getCurrentProject();

        File webapproot = project.getWebAppRoot();
        File webapprootNested = new File(webapproot, "foo");
        File indexHtml = new File(webapprootNested, "index.html");
        FileUtils.writeStringToFile(indexHtml, "<html>hi</html>");
        File fooSmd = new File(webapproot, "foo.smd");
        FileUtils.writeStringToFile(fooSmd, "{}");

        MockHttpServletRequest mhr = new MockHttpServletRequest("GET",
                "/servletname/projects/" + projectName + "/foo/index.html");
        MockHttpServletResponse mhresp = new MockHttpServletResponse();
        ...
        assertEquals(FileUtils.readFileToString(indexHtml), mhresp
                .getContentAsString());
        assertEquals(HttpServletResponse.SC_OK, mhresp.getStatus());
        assertEquals("text/html", mhresp.getContentType());
        ...
        mhr = new MockHttpServletRequest("GET",
                "/servletname/projects/" + projectName.toLowerCase() +
                "/foo/index.html");
        mhresp = new MockHttpServletResponse();
        mav = sc.handleRequest(mhr, mhresp);
        assertEquals(HttpServletResponse.SC_NOT_FOUND, mhresp.getStatus());
    ...
    // MAV-1857
    @Test public void testGetCaseSensitiveFile_CommonFiles() throws Exception {
