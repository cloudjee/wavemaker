...
public class TestJSONUtils extends TestSpringContextTestCase {
    ...
    public void testGetParameterTypes() throws Exception {
        ...
        method = ComplexReturnBean.class.getMethod("getComplexArray", ClassUtils.forName("int[]", null));
        ...
        method = ComplexReturnBean.class.getMethod("noTranslationObject", Object.class);
        ...
        method = ComplexReturnBean.class.getMethod("singleParameterType", Object.class, String.class);
        json = JSONUnmarshaller.unmarshal("[{\"name\":\"foo\"}," + "\"" + BeanClass.class.getCanonicalName() + "\"]");
        assertTrue(json.isList());
        params = (JSONArray) json;
        fDs = JSONUtils.getParameterTypes(method, params, typeState);
        ...
        method = ComplexReturnBean.class.getMethod("manyParameterTypes", Object.class, String.class, Object.class, Object.class, String.class);
        json = JSONUnmarshaller.unmarshal("[" + "{\"name\":\"foo\"}," + "\"" + BeanClass.class.getCanonicalName() + "\",{\"name\":\"bar\"},"
        ...
        try {
            method = ComplexReturnBean.class.getMethod("singleParameterType", Object.class, String.class);
            json = JSONUnmarshaller.unmarshal("[{\"name\":\"foo\"}," + "\"" + List.class.getCanonicalName() + "\"]");
            assertTrue(json.isList());
            params = (JSONArray) json;
    ...
    public void testFailedConversion() throws Exception {
        ...
        TypeState typeState = new ReflectTypeState();
        String[] jsonStrings = new String[] { "[\"foobar\"]", };
        ...
        fieldDefinitions.get(0).add(ReflectTypeUtils.getFieldDefinition(Integer.class, typeState, false, null));
        Object expected[][] = new Object[][] { new Object[] { null }, };
    ...
    @Test
    public void testConvertJSONToObjects() throws Exception {
        ...
        fieldDefinition.add(ReflectTypeUtils.getFieldDefinition(Integer.class, typeState, false, null));
        fieldDefinitions.add(fieldDefinition);

        fieldDefinition = new ArrayList<FieldDefinition>();
        fieldDefinition.add(ReflectTypeUtils.getFieldDefinition(int.class, typeState, false, null));
        fieldDefinitions.add(fieldDefinition);
        ...
        fieldDefinition = new ArrayList<FieldDefinition>();
        fieldDefinition.add(ReflectTypeUtils.getFieldDefinition(String.class, typeState, false, null));
        fieldDefinitions.add(fieldDefinition);

        fieldDefinition = new ArrayList<FieldDefinition>();
        fieldDefinition.add(ReflectTypeUtils.getFieldDefinition(Long.class, typeState, false, null));
        fieldDefinitions.add(fieldDefinition);

        fieldDefinition = new ArrayList<FieldDefinition>();
        fieldDefinition.add(ReflectTypeUtils.getFieldDefinition(byte.class, typeState, false, null));
        fieldDefinition.add(ReflectTypeUtils.getFieldDefinition(short.class, typeState, false, null));
        fieldDefinition.add(ReflectTypeUtils.getFieldDefinition(int.class, typeState, false, null));
        fieldDefinition.add(ReflectTypeUtils.getFieldDefinition(long.class, typeState, false, null));
        fieldDefinition.add(ReflectTypeUtils.getFieldDefinition(float.class, typeState, false, null));
        fieldDefinition.add(ReflectTypeUtils.getFieldDefinition(double.class, typeState, false, null));
        fieldDefinitions.add(fieldDefinition);
        ...
        Object[][] expected = new Object[][] {
            ...
            new Object[] { (byte) Long.MAX_VALUE, (short) Long.MAX_VALUE, (int) Long.MAX_VALUE, (long) Long.MAX_VALUE, (float) Long.MAX_VALUE,
                (double) Long.MAX_VALUE }, new Object[] { null }, };

        doTestConversion(jsonStrings, fieldDefinitions, typeState, expected);
    }

    @Test
    public void testConversionBadNonArraySeq() throws Exception {
        ...
        try {
            ...
            fieldDefinitions.add(ReflectTypeUtils.getFieldDefinition(int.class, jsonState.getTypeState(), false, null));
    ...
    // MAV-8
    @Test
    public void testConversionInternalArray() throws Exception {
        ...
        assertJSONStringsEquals("{\"outputType\":null,\"query\":null,\"comment\":null,\"isHQL\":false,"
            + "\"isGenerated\":false,\"returnsSingleResult\":false,\"name\":null," + "\"inputs\":[{\"paramType\":\"b\",\"paramName\":\"a\","
            + "\"list\":true}]}", jo);
    }

    @Test
    public void testConversionArrayFuncReturnsNull() throws Exception {

        JSONState jsonState = new JSONState();

        List<FieldDefinition> fieldDefinitions = new ArrayList<FieldDefinition>();
        fieldDefinitions.add(ReflectTypeUtils.getFieldDefinition(ClassUtils.forName("int[]", null), jsonState.getTypeState(), false, null));

        JSON json = JSONUnmarshaller.unmarshal("[null]");
        assertTrue(json.isList());
        JSONArray jarr = (JSONArray) json;
        ParsedServiceArguments ret = JSONUtils.convertJSONToObjects(jarr, fieldDefinitions, jsonState);
    ...
    @Test
    public void testGetParameterTypes_BadTypeInJSONParam() throws Exception {

        TypeState typeState = new ReflectTypeState();

        Method method = ComplexReturnBean.class.getMethod("singleParameterType", Object.class, String.class);
        ...
        try {
            ...
            assertEquals(MessageResource.JSONPARAMETER_COULD_NOTLLOAD_TYPE.getId(), e.getMessageId());
        }
    }

    private void doTestConversion(String[] jsonStrings, List<List<FieldDefinition>> fieldDefinitions, TypeState typeState, Object[][] expected)
        throws Exception {
        ...
        for (int i = 0; i < jsonStrings.length; i++) {
            ...
            assertTrue(json.isList());
            JSONArray jarr = (JSONArray) json;
            Object[] result = JSONUtils.convertJSONToObjects(jarr, fieldDefinitions.get(i), jsonState).getArguments();

            String message = "error index " + i + "; jsonString: " + jsonStrings[i] + ", result: " + result;
    ...
    protected void assertClassArrayEquals(Class<?>[] expected, Class<?>[] actual) {
        ...
        for (int i = 0; i < expected.length; i++) {
            assertEquals("arrays differ at position " + i + ", expected: " + expected[i] + ", actual: " + actual[i], expected[i], actual[i]);
        }
    }
}