...
public class TestJSONRPCController extends TestSpringContextTestCase {
    ...
    @Test public void testHandleNoargRequest() throws Exception {
    ...
    @Test public void testHandleNoargRequest_EmptyArray() throws Exception {
     ...
     * @throws Exception
     */
    @Test public void testHandleNoargRequest_DojoNoParameterDefault()
            throws Exception {
    ...
    @DirtiesContext
    @Test public void testHandleNoargRequest_NonEmptyParamObject() throws Exception {
    ...
    @Test public void testHandleArgRequest_Dojo() throws Exception {
    ...
    @Test public void testReflectionInvoke_getProduct_1() throws Exception {
    ...
    @Test public void testReflectionInvoke_retProduct() throws Exception {
    ...
    @DirtiesContext
    @Test public void testReflectionInvoke_badMethod() throws Exception {
     ...
     */
    @Test public void testServletEventListener() throws Exception {
    ...
    @Test public void testServiceEventListener() throws Exception {
    ...
    @Test public void testServiceEventListenerMultiple() throws Exception {
    ...
    @Test public void testOverloadInvoke() throws Exception {
    ...
    @Test public void testBadOverloadInvoke() throws Exception {
    ...
    @Test public void testExclusion_IncludeRecursive() throws Exception {
    ...
    @Test public void testGetUtilDate() throws Exception {
    ...
    @Test public void testGetSqlDate() throws Exception {
    ...
    @Test public void testGetAndParamSqlDate() throws Exception {
    ...
    @Test public void testGetAndParamUtilDate() throws Exception {
    ...
    // test MAV-442
    @Test public void testGetAndParamSqlTime() throws Exception {
    ...
    // test MAV-442
    @Test public void testGetAndParamSqlTimestamp() throws Exception {
    ...
    // MAV-2198
    @Test public void testGetAndParamUtilDate_Negative() throws Exception {
    ...
    // test MAV-8
    @Test public void testArrayParameters() throws Exception {
    ...
    // test MAV-8 2
    @Test public void testArrayParametersSecondLevel() throws Exception {
        ...
        String ret = resp.getContentAsString();
        assertJSONStringsEquals("{\""+ServerConstants.RESULTS_PART+
                "\":\"getActorById, 1\"}", ret);
    }

    @Test public void testNullAsArrayParameterAndReturn() throws Exception {
        ...
        String ret = resp.getContentAsString();
        assertJSONStringsEquals("{\""+ServerConstants.RESULTS_PART+"\":null}",
                ret);
    }

    // MAV-9
    @Test public void testNullAsListParameterAndReturn() throws Exception {
    ...
    // MAV-9
    @Test public void testNullAsArrayInObjectReturn() throws Exception {
    ...
    // test MAV-6
    @Test public void testNullParameters() throws Exception {
    ...
    @Test public void testArrayInObjectReturn() throws Exception {
    ...
    @Test public void testIntegerReturnReallyNull() throws Exception {
    ...
    @Test public void testGetReturnStringList() throws Exception {
    ...
    @Test public void testStringStringArray() throws Exception {
    ...
    @Test public void testStringStringEmptyArray() throws Exception {
    ...
    @Test public void testReflectionInvokeException() throws Exception {
    ...
    @Test public void testGetCycle() throws Exception {
    ...
    // MAV-538
    @Test public void testTakesLong() throws Exception {
    ...
    @Test public void testTakesLCInt() throws Exception {
    ...
    @Test public void testTakesLCIntWithString() throws Exception {
    ...
    // MAV-559
    @Test public void testWrappedDate() throws Exception {
        ...
        invokeService("dateReturnBean", "getWrappedDate", new Object[]{wd},
                response);
        assertJSONStringsEquals("{\"result\":{"+
    ...
    // MAV-589
    @Test public void testUnwrappingExceptions() throws Exception {
        try {
            invokeService_toObject("complexReturnBean",
    ...
    // MAV-855
    @Test public void testExtendedCharsString() throws Exception {
    ...
    // MAV-879
    @Test public void testSetterList() throws Exception {
    ...
    @Test public void testTakesProperties() throws Exception {
    ...
    @Test public void testSuccessResponse() throws Exception {
    ...
    // MAV-1204
    @Test public void testCallHiddenMethod() throws Exception {
    ...
    // MAV-1792
    @Test public void testReturnListDates() throws Exception {
    ...
    // MAV-1792
    @Test public void testReturnMapDates() throws Exception {
    ...
    // MAV-2060
    @Test public void testGetDatesInUntypedResponse() throws Exception {
    ...
    // MAV-2060
    @Test public void testGetDateUntypedResponse() throws Exception {
    ...
    // MAV-2149
    @Test public void testReturnLOBs() throws Exception {
    ...
    // MAV-2149
    @Test public void testParameterLOBs() throws Exception {
    ...
    // MAV-2241
    @Test public void testUntypedMapParameter() throws Exception {
    ...
    // MAV-2244
    @Test public void testUntypedObject() throws Exception {
    ...
    // MAV-2275
    @Test public void testStringArrayArgument() throws Exception {
    ...
    // MAV-823
    @Test public void testStringBuffer() throws Exception {
    ...
    @Test public void testGetFromAopAdvised() throws Exception {
