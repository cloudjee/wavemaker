...
public class TestWebService extends StudioTestCase {
    ...
    @Test public void testRegisterFeedService() throws Exception {
    ...
    @Test public void testImportWSDL() throws Exception {
        makeProject(this.getName());
    ...
    @Test public void testImportWSDLWithNonExistingWSDL() throws Exception {
        makeProject(this.getName());
    ...
    @Test public void testImportWADL1() throws Exception {
        makeProject(this.getName());
        String resource = ClassLoaderUtils
    ...
    @Test public void testImportWADL2() throws Exception {
        makeProject(this.getName());
        String resource = ClassLoaderUtils
    ...
    @Test public void testGetWSDLWithInvalidServiceId() throws Exception {
    ...
    @Test public void testBindingProperties() throws Exception {
        makeProject(this.getName());
        String resource = ClassLoaderUtils
                .getResource("com/wavemaker/runtime/ws/YahooTrafficData.wsdl");
        String filePath = (new URL(resource)).getFile();
    ...
    @Test public void testSetBindingPropertiesWithInvalidServiceId()
            throws Exception {
        makeProject(this.getName());
        String serviceId = "dummyService";
        BindingProperties bindingProperties = new BindingProperties();
