...
import com.wavemaker.tools.cloudmgr.opsource.stopserver.proc.StopServerProc;
...
public class DeleteServerProc {
    ...
    public Status deleteServer(String orgId, String serverId, String userName, String passWord) {
        ...
        Status status;
        com.wavemaker.tools.cloudmgr.opsource.stopserver.response.Status status1;
        StopServerProc stopServerProc = new StopServerProc();

        status1 = stopServerProc.stopServer(serverId, orgId, userName, passWord);
        String resultCode = status1.getResultCode();
