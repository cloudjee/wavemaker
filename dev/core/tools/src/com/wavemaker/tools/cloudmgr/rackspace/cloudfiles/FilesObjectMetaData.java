...
public class FilesObjectMetaData
{
   ...
   void setLastModified(String lastModified)
    ...
    {
        metaData.put(Constants.X_OBJECT_META.concat(key), value);
    }
    ...
    {
        return metaData.get(Constants.X_OBJECT_META.concat(key));
    }
    ...
    {
        return metaData.containsKey(Constants.X_OBJECT_META.concat(key));
    }
}
