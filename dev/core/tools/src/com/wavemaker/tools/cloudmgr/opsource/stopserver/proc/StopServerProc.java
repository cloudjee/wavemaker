...
package com.wavemaker.tools.cloudmgr.opsource.stopserver.proc;
...
import com.wavemaker.tools.cloudmgr.opsource.stopserver.response.Status;
 ...
 * @author slee
 */
public class StopServerProc {

    public Status stopServer(String serverId, String orgId, String userName, String passWord) {

        String endPointAddress = "https://api.opsourcecloud.net/oec/0.9/" + orgId + "/server/" + serverId + "?stop";
