...
/**
 * <p>
 * Java class for Servers element declaration.
 * 
 * <p>
...
public class Servers {
     ...
     */
    @XmlAccessorType(XmlAccessType.FIELD)
    @XmlType(name = "", propOrder = { "id", "name", "description", "vlanResourcePath", "imageResourcePath", "cpuCount", "memory", "osStorage",
        "additionalLocalStorage", "machineName", "privateIPAddress", "isDeployed", "isStarted", "created", "operatingSystem" })
