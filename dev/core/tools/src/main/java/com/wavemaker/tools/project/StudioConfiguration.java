...
public interface StudioConfiguration {
	...
	/**
	 * Return the projects directory ("projects", inside of the path returned by
	 * {@link #getWaveMakerHome()}. This can be overridden with the system
	 * property PROJECTHOME_KEY.
	 * 
	 * @return
	 * @throws IOException
	 */
