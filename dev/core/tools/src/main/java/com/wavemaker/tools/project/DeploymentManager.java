...
public class DeploymentManager {
    ...
    public void buildWar(String projectDir, String buildDir, String warFile, boolean includeEar) {
    ...
    public String buildWar() throws IOException {
        Resource dist = this.studioConfiguration.createPath(getProjectDir(), DIST_DIR_DEFAULT);
    ...
    protected Resource getProjectDir() {
        com.wavemaker.tools.project.Project currentProject = this.projectManager.getCurrentProject();
