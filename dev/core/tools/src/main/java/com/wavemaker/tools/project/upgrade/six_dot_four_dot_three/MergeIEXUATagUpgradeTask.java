...
public class MergeIEXUATagUpgradeTask implements UpgradeTask {
	...
	if (index1 == -1 || index2 == -1) return indexContent;
	...
	return indexContent.substring(0,index1) + "<meta http-equiv=\"X-UA-Compatible\" content=\"IE=9; IE=8; chrome=1\">" + indexContent.substring(index2);
    }
