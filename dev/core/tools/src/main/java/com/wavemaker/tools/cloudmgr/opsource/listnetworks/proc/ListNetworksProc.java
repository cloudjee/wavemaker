...
package com.wavemaker.tools.cloudmgr.opsource.listnetworks.proc;
 ...
 * @author slee
 */
public class ListNetworksProc {

    public Networks listNetworks(String orgId, String userName, String passWord) {

        String endPointAddress = "https://api.opsourcecloud.net/oec/0.9/" + orgId + "/network";
        ...
        try {
            ...
            JAXBContext context = JAXBContext.newInstance(Networks.class);
            Unmarshaller unmarshaller = context.createUnmarshaller();
            Object object = unmarshaller.unmarshal(inputStream);
            networks = Networks.class.cast(object);
