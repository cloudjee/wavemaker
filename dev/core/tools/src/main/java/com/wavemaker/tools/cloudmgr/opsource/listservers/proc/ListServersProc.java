...
package com.wavemaker.tools.cloudmgr.opsource.listservers.proc;
 ...
 * @author slee
 */
public class ListServersProc {

    public Servers listServers(String orgId, String userName, String passWord) {
        ...
        try {
            ...
            servers =  Servers.class.cast(object);
