Information about project structure and files.

lib
 Add custom jar files to this folder. Files added to this folder will be copied to WEB-INF for deployment.
...
src
 Custom java classes can be added to this folder using package names. Files added to this folder will be copied to WEB-INF for deployment.
  log4j.properties should be edited to change logging settings.
...
webapproot
  ...
  project.js (i.e. myproject.js) contains any application owned 
  
webapproot/data
 Contains example HSQLDB files. If your project does not use HSQLDB, you can delete these files.
 
webapproot/pages
 Each project page creates a folder. All page files in the pages folder are studio managed. 
...
webapproot/WEB-INF/classes
  This folder is populated by studio. Do not edit or add any files to this folder. Changes will be lost. Use project/src isntead.
