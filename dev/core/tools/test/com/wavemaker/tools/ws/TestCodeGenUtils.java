...
public class TestCodeGenUtils extends WMTestCase {
    ...
    public void testConstructPackageName() {
        String packageName = CodeGenUtils.constructPackageName(
                "http://schemas.microsoft.com/MSNSearch/2005/09/fex", "MSNSearchService");
        assertEquals("com.microsoft.schemas.msnsearch._2005._09.fex.msnsearchservice", packageName);
        packageName = CodeGenUtils.constructPackageName(
                "http://webservices.amazon.com/AWSECommerceService/2005-10-05", "AmazonRESTService");
