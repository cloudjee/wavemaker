...
public class TestWSDLRest extends WMTestCase {
    ...
    public static WSDL getYahooStockQuoteWSDL() throws Exception {
        return TestWSDL.getWSDL("com/wavemaker/runtime/ws/YahooStockQuote.wsdl");
    }

    public static WSDL getYahooTrafficDataWSDL() throws Exception {
        return TestWSDL.getWSDL("com/wavemaker/runtime/ws/YahooTrafficData.wsdl");
    }

    public static WSDL getAmazonSearchWSDL() throws Exception {
        String wsdlResource = "com/wavemaker/runtime/ws/AmazonREST.wsdl";
        List<String> bindingResources = new ArrayList<String>();
        bindingResources.add("com/wavemaker/runtime/ws/AmazonRESTService1.xjb");
