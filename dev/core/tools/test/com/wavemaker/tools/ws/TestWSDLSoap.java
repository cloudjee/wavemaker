...
public class TestWSDLSoap extends WMTestCase {
    ...
    public static WSDL getStockQuoteWSDL() throws Exception {
        return TestWSDL.getWSDL("com/wavemaker/runtime/ws/stockquote.wsdl");
    }
    
    public static WSDL getSalesforceWSDL() throws Exception {
        String wsdlResource = "com/wavemaker/runtime/ws/salesforceEnterprise.wsdl";
        List<String> bindingResources = new ArrayList<String>();
        bindingResources.add("com/wavemaker/runtime/ws/SforceService1.xjb");
        bindingResources.add("com/wavemaker/runtime/ws/SforceService2.xjb");
        bindingResources.add("com/wavemaker/runtime/ws/SforceService3.xjb");
        return TestWSDL.getWSDL(wsdlResource, bindingResources);
    }

    public static WSDL getWeatherForecastWSDL() throws Exception {
        String wsdlResource = "com/wavemaker/runtime/ws/WeatherForecast.wsdl";
        List<String> bindingResources = new ArrayList<String>();
        bindingResources.add("com/wavemaker/runtime/ws/global-binding.xjb");
        bindingResources.add("com/wavemaker/runtime/ws/WeatherForecast1.xjb");
        return TestWSDL.getWSDL(wsdlResource, bindingResources);
    }
    
    public static WSDL getBasicRealTimeQuotesWSDL() throws Exception {
        String wsdlResource = "com/wavemaker/runtime/ws/BasicRealTimeQuotes.wsdl";
        List<String> bindingResources = new ArrayList<String>();
        bindingResources.add("com/wavemaker/runtime/ws/global-binding.xjb");
        bindingResources.add("com/wavemaker/runtime/ws/BasicRealTimeQuotes1.xjb");
        bindingResources.add("com/wavemaker/runtime/ws/BasicRealTimeQuotes2.xjb");
        return TestWSDL.getWSDL(wsdlResource, bindingResources);
    }
    ...
    public static WSDL getUSHolidayDatesWSDL() throws Exception {
        String wsdlResource = "com/wavemaker/runtime/ws/USHolidayDates.wsdl";
        List<String> bindingResources = new ArrayList<String>();
        bindingResources.add("com/wavemaker/runtime/ws/global-binding.xjb");
        bindingResources.add("com/wavemaker/runtime/ws/USHolidayDates1.xjb");
        return TestWSDL.getWSDL(wsdlResource, bindingResources);
    }

    public static WSDL getSingleCharService() throws Exception {
        return TestWSDL.getWSDL("com/wavemaker/runtime/ws/SingleCharService.wsdl");
    }

    public static WSDL getHelloWorldWSDL() throws Exception {
        return TestWSDL.getWSDL("com/wavemaker/runtime/ws/HelloWorld.wsdl");
    }
