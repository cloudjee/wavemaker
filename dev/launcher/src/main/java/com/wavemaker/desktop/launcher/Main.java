...
public class Main
{
            ...
            MalformedURLException
    {
        ...
        File studioDir = getStudioDir();
        File wmToolsJar = new File(studioDir, "WEB-INF/lib/wm-tools-6.4.0.BUILD-SNAPSHOT.jar");  //TODO: Name
    ...
    private static File getWaveMakerHome()
    {
        ...
        Object result = invokeFromWM(
                "com.wavemaker.tools.project.LocalStudioConfiguration",
                "getWaveMakerHome", new Class<?>[]
                {
                }, new Object[]
                {
                }, false);
        return ((FileSystemResource)result).getFile();
    }

    private static void setDemosDir(File newDemosDir)
    {

        invokeFromWM("com.wavemaker.tools.project.LocalStudioConfiguration",
