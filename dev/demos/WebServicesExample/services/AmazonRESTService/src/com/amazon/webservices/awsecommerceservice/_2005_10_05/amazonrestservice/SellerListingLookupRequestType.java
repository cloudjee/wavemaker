...
@XmlType(name = "SellerListingLookupRequest", namespace = "http://webservices.amazon.com/AWSECommerceService/2005-10-05", propOrder = {
    "id",
    "idType",
    "responseGroups"
})
public class SellerListingLookupRequestType {

    @XmlElement(name = "Id", namespace = "http://webservices.amazon.com/AWSECommerceService/2005-10-05")
    protected String id;
