...
@XmlType(name = "CartAddRequest", namespace = "http://webservices.amazon.com/AWSECommerceService/2005-10-05", propOrder = {
    "cartId",
    "hmac",
    "mergeCart",
    "items",
...
public class CartAddRequestType {
    ...
    protected CartAddRequestType.Items items;
     ...
     * @return
     *     possible object is
     *     {@link CartAddRequestType.Items }
     *     
     */
    public CartAddRequestType.Items getItems() {
        return items;
    }
     ...
     *     
     */
    public void setItems(CartAddRequestType.Items value) {
        this.items = value;
    }
    ...
    public static class Items {
        ...
        protected List<CartAddRequestType.Items.Item> items;
         ...
         * <p>
         * Objects of the following type(s) are allowed in the list
         * {@link CartAddRequestType.Items.Item }
         * 
         * 
         */
        public List<CartAddRequestType.Items.Item> getItems() {
            if (items == null) {
                items = new ArrayList<CartAddRequestType.Items.Item>();
            }
            return this.items;
        }
         ...
         *     
         */
        public void setItems(List<CartAddRequestType.Items.Item> items) {
            this.items = items;
        }
