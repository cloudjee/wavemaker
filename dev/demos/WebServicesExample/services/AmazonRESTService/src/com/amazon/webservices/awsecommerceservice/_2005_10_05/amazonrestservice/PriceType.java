...
@XmlType(name = "Price", namespace = "http://webservices.amazon.com/AWSECommerceService/2005-10-05", propOrder = {
    "amount",
    "currencyCode",
    "formattedPrice"
})
public class PriceType {
    ...
    @XmlElement(name = "Amount", namespace = "http://webservices.amazon.com/AWSECommerceService/2005-10-05")
    protected BigInteger amount;
    @XmlElement(name = "CurrencyCode", namespace = "http://webservices.amazon.com/AWSECommerceService/2005-10-05")
    protected String currencyCode;
    @XmlElement(name = "FormattedPrice", namespace = "http://webservices.amazon.com/AWSECommerceService/2005-10-05", required = true)
