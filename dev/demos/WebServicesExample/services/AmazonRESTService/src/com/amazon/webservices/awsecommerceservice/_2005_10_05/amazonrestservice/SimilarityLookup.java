 ...
 *         &lt;element name="Shared" type="{http://webservices.amazon.com/AWSECommerceService/2005-10-05}SimilarityLookupRequest" minOccurs="0"/>
 *         &lt;element name="Request" type="{http://webservices.amazon.com/AWSECommerceService/2005-10-05}SimilarityLookupRequest" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "SimilarityLookup", namespace = "http://webservices.amazon.com/AWSECommerceService/2005-10-05")
public class SimilarityLookup {
    ...
    protected SimilarityLookupRequestType shared;
    @XmlElement(name = "Request", namespace = "http://webservices.amazon.com/AWSECommerceService/2005-10-05")
    protected List<SimilarityLookupRequestType> requests;
     ...
     *     
     */
    public SimilarityLookupRequestType getShared() {
        return shared;
    }
     ...
     *     
     */
    public void setShared(SimilarityLookupRequestType value) {
        this.shared = value;
    }
     ...
     * 
     */
    public List<SimilarityLookupRequestType> getRequests() {
        if (requests == null) {
            requests = new ArrayList<SimilarityLookupRequestType>();
        }
     ...
     *     
     */
    public void setRequests(List<SimilarityLookupRequestType> requests) {
