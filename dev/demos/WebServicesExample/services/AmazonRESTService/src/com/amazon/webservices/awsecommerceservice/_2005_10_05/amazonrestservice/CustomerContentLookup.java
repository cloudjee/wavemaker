 ...
 *         &lt;element name="Shared" type="{http://webservices.amazon.com/AWSECommerceService/2005-10-05}CustomerContentLookupRequest" minOccurs="0"/>
 *         &lt;element name="Request" type="{http://webservices.amazon.com/AWSECommerceService/2005-10-05}CustomerContentLookupRequest" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "CustomerContentLookup", namespace = "http://webservices.amazon.com/AWSECommerceService/2005-10-05")
public class CustomerContentLookup {
    ...
    protected CustomerContentLookupRequestType shared;
    @XmlElement(name = "Request", namespace = "http://webservices.amazon.com/AWSECommerceService/2005-10-05")
    protected List<CustomerContentLookupRequestType> requests;
     ...
     *     
     */
    public CustomerContentLookupRequestType getShared() {
        return shared;
    }
     ...
     *     
     */
    public void setShared(CustomerContentLookupRequestType value) {
        this.shared = value;
    }
     ...
     * 
     */
    public List<CustomerContentLookupRequestType> getRequests() {
        if (requests == null) {
            requests = new ArrayList<CustomerContentLookupRequestType>();
        }
     ...
     *     
     */
    public void setRequests(List<CustomerContentLookupRequestType> requests) {
