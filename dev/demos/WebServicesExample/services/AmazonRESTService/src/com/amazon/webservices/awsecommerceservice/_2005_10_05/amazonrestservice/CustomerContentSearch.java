 ...
 *         &lt;element name="Shared" type="{http://webservices.amazon.com/AWSECommerceService/2005-10-05}CustomerContentSearchRequest" minOccurs="0"/>
 *         &lt;element name="Request" type="{http://webservices.amazon.com/AWSECommerceService/2005-10-05}CustomerContentSearchRequest" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "CustomerContentSearch", namespace = "http://webservices.amazon.com/AWSECommerceService/2005-10-05")
public class CustomerContentSearch {
    ...
    protected CustomerContentSearchRequestType shared;
    @XmlElement(name = "Request", namespace = "http://webservices.amazon.com/AWSECommerceService/2005-10-05")
    protected List<CustomerContentSearchRequestType> requests;
     ...
     *     
     */
    public CustomerContentSearchRequestType getShared() {
        return shared;
    }
     ...
     *     
     */
    public void setShared(CustomerContentSearchRequestType value) {
        this.shared = value;
    }
     ...
     * 
     */
    public List<CustomerContentSearchRequestType> getRequests() {
        if (requests == null) {
            requests = new ArrayList<CustomerContentSearchRequestType>();
        }
     ...
     *     
     */
    public void setRequests(List<CustomerContentSearchRequestType> requests) {
