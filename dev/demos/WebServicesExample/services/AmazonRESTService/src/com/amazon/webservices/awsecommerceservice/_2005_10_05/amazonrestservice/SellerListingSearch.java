 ...
 *         &lt;element name="Shared" type="{http://webservices.amazon.com/AWSECommerceService/2005-10-05}SellerListingSearchRequest" minOccurs="0"/>
 *         &lt;element name="Request" type="{http://webservices.amazon.com/AWSECommerceService/2005-10-05}SellerListingSearchRequest" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "SellerListingSearch", namespace = "http://webservices.amazon.com/AWSECommerceService/2005-10-05")
public class SellerListingSearch {
    ...
    protected SellerListingSearchRequestType shared;
    @XmlElement(name = "Request", namespace = "http://webservices.amazon.com/AWSECommerceService/2005-10-05")
    protected List<SellerListingSearchRequestType> requests;
     ...
     *     
     */
    public SellerListingSearchRequestType getShared() {
        return shared;
    }
     ...
     *     
     */
    public void setShared(SellerListingSearchRequestType value) {
        this.shared = value;
    }
     ...
     * 
     */
    public List<SellerListingSearchRequestType> getRequests() {
        if (requests == null) {
            requests = new ArrayList<SellerListingSearchRequestType>();
        }
     ...
     *     
     */
    public void setRequests(List<SellerListingSearchRequestType> requests) {
