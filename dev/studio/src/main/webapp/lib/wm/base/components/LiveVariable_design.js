...
wm.Object.extendSchema(wm.LiveVariable, {
	...
	liveView: { ignore: 1},
    sourceData: {group: "data", order: 3, bindTarget: 1, treeBindField: "sourceData",editor: "wm.prop.DataSetSelect", editorProps: {matchComponentType: true}},
    filter:     {group: "data", order: 5, bindTarget: 1, treeBindField: "filter",    editor: "wm.prop.DataSetSelect", editorProps: {matchComponentType: true}},
