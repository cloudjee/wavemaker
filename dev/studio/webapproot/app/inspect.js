...
dojo.declare("wm.EventEditor", dijit.form.ComboBox, {
	...
	generateStore: function() {
      ...
      var sharedEventHandlers = eventList(this.inspected.getSharedEventLookupName(this.propName), wm.isInstanceType(studio.selected.owner, wm.BasicApplication) ? studio.appsourceEditor : studio.editArea);
