...
HandleRequiredJars.widgets = {
	...
	dialog: ["wm.Panel", {layoutKind: "top-to-bottom",  width: "100%", height: "100%", border: "10,10,0,10", borderColor: "#424959"}, {}, {
	    ...
	    layers: ["wm.WizardLayers", {width: "100%", height: "100%", clientBorder: "0"}, {onCancelClick: "close", onDoneClick: "close"}, {
