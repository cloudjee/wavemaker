...
HandleRequiredJars.widgets = {
	...
	dialog: ["wm.Panel", {layoutKind: "top-to-bottom",  width: "100%", height: "100%", border: "10", borderColor: "#424959"}, {}, {
	    ...
	    layers: ["wm.WizardLayers", {width: "100%", height: "100%", clientBorder: "2", clientBorderColor: "#BBB"}, {onCancelClick: "close", onDoneClick: "close"}, {
		...
		layer3: ["wm.Layer", {showing: false, caption: "Step 3", padding: "5", verticalAlign: "top", horizontalAlign: "left"}, {}, {
		    html2: ["wm.Html", {width: "100%", height: "100%"}]
		}],
		layer4: ["wm.Layer", {showing: false, caption: "Step 4", padding: "5", layoutKind: "left-to-right", verticalAlign: "top", horizontalAlign: "left"}, {}, {
		...
		layer5: ["wm.Layer", {showing: false, caption: "Step 5", padding: "5", verticalAlign: "top", horizontalAlign: "left"}, {}, {
		    html3: ["wm.Html", {width: "100%", height: "100%"}]
		}],
		layer6: ["wm.Layer", {showing: false, caption: "Step 6", padding: "5", layoutKind: "left-to-right", verticalAlign: "top", horizontalAlign: "left"}, {}, {
		...
		layer7: ["wm.Layer", {caption: "End", padding: "5", verticalAlign: "top", horizontalAlign: "left"}, {}, {
		    labeld1: ["wm.Label", {singleLine: false, width: "100%", height: "30px", caption: "Now restart studio"}],
		    labeld2: ["wm.Html", {width: "100%",height: "100%", html: "<ol><li>Restart the studio application (server) that you launched from your computer's file system</li><li>After you've restarted your application, reload studio in your browser</li></ol>"}]
		}]
