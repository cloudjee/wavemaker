...
/*		    userLevelListPanel: ["wm.Panel", {height: "100%", width: "90px", layoutKind: "top-to-bottom", border: "0,0,0,4", borderColor: "black"}, {}, {
		...
		pageWithSideNavLayer: ["wm.Layer", {caption: "Preview Doc with TOC", themeWidgets: "themeGroupWidgets_SideNav"},{},{
			demoPanel3: ["wm.Panel", { height: "100%", width: "100%", layoutKind: "top-to-bottom", margin: "15", padding: "15",  border: "2", borderColor: "#F0F0F0"}]
		    }],
		pageWithNoNavLayer: ["wm.Layer", {caption: "Preview Simple Doc", themeWidgets: "themeGroupWidgets_NoNav"},{},{
			demoPanel5: ["wm.Panel", { height: "100%", width: "100%", layoutKind: "top-to-bottom", margin: "15", padding: "15",  border: "2", borderColor: "#F0F0F0"}]
		    }],
		    viewWidgetsLayer: ["wm.Layer", {caption: "Preview Widget Set"},{},{
			demoPanel2: ["wm.Panel", { height: "100%", width: "100%", layoutKind: "top-to-bottom", margin: "0", padding: "0",  border: "2", borderColor: "#F0F0F0"}]
		    }],
		    viewOneWidgetLayer: ["wm.Layer", {caption: "Preview One Widget"},{},{
