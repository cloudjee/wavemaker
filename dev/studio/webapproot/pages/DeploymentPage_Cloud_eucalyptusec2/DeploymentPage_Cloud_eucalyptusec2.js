...
dojo.provide("wm.studio.pages.DeploymentPage_Cloud_eucalyptusec2.DeploymentPage_Cloud_eucalyptusec2");

dojo.declare("DeploymentPage_Cloud_eucalyptusec2", wm.Page, { 
	signatureVersion: "1",
	serviceURL: null,
	loginError: false,
    start: function() {
    ...
    callServerList: function(message, inLayer) {
		if (this.callServerListEnabled) {
			...
			this.cloudServerService.requestSync("getServerList", 
							 [ "eucalyptus", null, null, null, this.accessKeyIdValue, this.secretAccessKeyValue,
								this.signatureVersion,
								this.serviceURL],
	...
	if (this.callServerBaseInfoEnabled) {
		...
		this.VMTypeList.setDataValue("m1.large");
