...
QueryEditor.widgets = {
	...
	layoutBox1: ["wm.Layout", {_classes: {domNode: ["wm-darksnazzy"]}, height: "100%", imageList: "smallToolbarImageList"}, {}, {
	    editorToolbar: ["wm.Panel", {border: "0", height: "29px", width: "100%", layoutKind: "left-to-right"}, {}, {
			...
			panel6a: ["wm.Panel", {border: "0", height: "100%", width: "100%"}, {}, {
			    panel1: ["wm.Panel", {border: "0", height: "100%", width: "100%", minWidth: "400", verticalAlign: "top", horizontalAlign: "left"}, {}, {
					...
					queryTopHalfPanel: ["wm.Panel", {border: "0", height: "100%", width: "100%"}, {}, {
						...
						queryDefLabel: ["wm.Label", {caption: "Query Definition", border: "0", height: "18px", width: "100%"}, {}, {
					    ...
					    queryParamsLabel: ["wm.Label", {caption: "Query Parameters", border: "0", height: "18px", width: "100%"}, {}, {
								format: ["wm.DataFormatter", {}, {}]
							}],
						...
						addNewParamPanel: ["wm.Panel", {border: "0", height: "28px", width:"100%", layoutKind: "left-to-right", padding: "0", verticalAlign: "center"}, {}, {
								...
								bindNameInput: ["wm.Text", {layoutKind: "left-to-right", caption: "Name", padding: "", captionSize: "50px", width: "150px", height: "20px"}, {onchange: "parameterPropEdit"}, {
                                                                    binding: ["wm.Binding", {}, {}, {
								...
								isInputListCheckBox: ["wm.Checkbox", {caption: "List", padding: "2,0,0,0", captionSize: "60px", width: "80px", height: "20px"}, {onchange: "parameterPropEdit"}, {
                                                                    binding: ["wm.Binding", {}, {}, {
					                                wire: ["wm.Wire", {"targetProperty":"disabled","source":"queryInputsList.emptySelection"}, {}]
				                                    }]
								}],
