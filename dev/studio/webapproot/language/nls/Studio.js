...

{
    ...
    ALERT_BUILDING_ZIP_SUCCESS: "Successfully exported project to zip file at ${inResponse}.\n\nTo import this project unzip it into the projects directory of another studio.",
    ALERT_BUILDING_ZIP_FAILED: "Error occurred while building ZIP FILE!\n${error}",
    ALERT_BUILDING_WAR_SUCCESS: "Successfully generated WAR file at ${inResponse}.",
    ALERT_BUILDING_WAR_FAILED: "Error occurred while building WAR FILE!\n${error}",
    ...
    ALERT_DEPLOY_FAILED: "Deployment error: ${error}",
