	...
	next: function(){
		...
		if(this.cell){
			...
			if(this.grid.edit.isEditing()){ //when editing, only navigate to editable cells
				...
				else if (this.isLastFocusCell())
				{
					// if this cell is a last focused cell in editing mode, 
					// and now if user hits tab key, we should assume that he has hit the ENTER key and finish editing.
					var e = {keyCode:dojo.keys.ENTER};
