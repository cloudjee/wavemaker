 ...
 */
dojo.provide("wm.base.mobile.Html");

dojo.declare("wm.mobile.Html", wm.Control, {
	html: "",
        autoScroll: true,
	init: function() {
...
wm.mobile.Html.description = "Container for any HTML content.";

wm.Object.extendSchema(wm.mobile.Html, {
	disabled: { ignore: 1 },
