 ...
 */
dojo.provide("wm.base.mobile.ListViewer");


dojo.declare("wm.mobile.ListViewerRow", wm.mobile.Container, {
    lock: true,
 ...
 */
dojo.declare("wm.mobile.ListViewer", wm.mobile.Container, {
    _selectedIndex: -1,
    selectedItem: null,
...
/*
	...
	for (var i = 0; i < length; i++) {
		...
		this.currentRenderer = this[name] = this.rowRenderers[i] = dojo.mixin(new wm.mobile.ListViewerRow({name: name, owner: this, parent: this, replacementNode: this.nodes[i]}), this._js);
...
wm.Object.extendSchema(wm.mobile.ListViewer, {
...
if (!wm.studioConfig) {
    wm.ListViewer = wm.mobile.ListViewers;
}