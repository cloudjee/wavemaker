 ...
 */
dojo.provide("wm.base.mobile.VirtualList");

dojo.declare("wm.mobile.VirtualListItem", null, {
	selected: false,
...
dojo.declare("wm.mobile.VirtualList", wm.Control, {
	headerVisible: true,
	toggleSelect: false,
	width: "250px",
	height: "150px",
	...
	createItem: function(inContent) {
		return new wm.mobile.VirtualListItem(this, inContent);
	},
...
wm.Object.extendSchema(wm.mobile.VirtualList, {
