 ...
 */
dojo.provide("wm.base.mobile.Layers_design");
dojo.require("wm.base.mobile.Layers");

// design-time
wm.Object.extendSchema(wm.mobile.Layer, {
	title: { ignore: 1 },
	disabled: { ignore: 1 },
...
wm.Object.extendSchema(wm.mobile.Layers, {
	lock: {ignore: 1},
	freeze: {ignore: 1},
	box: {ignore: 1},
...
wm.mobile.Layers.description = "Show widgets on layers.";

wm.mobile.TabLayers.description = "Layers with tab navigation.";
