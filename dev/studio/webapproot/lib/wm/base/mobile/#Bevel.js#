 ...
 */
dojo.provide("wm.base.mobile.Bevel");

dojo.declare("wm.mobile.Bevel", wm.Control, {
	className: "wmmobbevel",
	flex: 0,
        bevelSize: 1,
    _dontRenderCss: true,
	init: function() {
...
// design-time
wm.Object.extendSchema(wm.mobile.Bevel, {
	vertical: { ignore: 1 },
	disabled: { ignore: 1 },
	border: {ignore: 1},
