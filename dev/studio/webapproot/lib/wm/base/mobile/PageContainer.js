 ...
 */
dojo.provide("wm.base.mobile.PageContainer");
dojo.require("wm.base.components.Page");
dojo.require("wm.base.mobile.Panel");

wm.pagesFolder = "pages/";

dojo.declare("wm.mobile.PageContainer", wm.Control, {
	width: "100%", 
	height: "100%",
	pageName: "",
	deferLoad: false,
...
// design only
wm.mobile.PageContainer.extend({
        themeable: false,
	scrim: true,
	_isBindSource: true,
	...
	dojo.forEach(pages, function(p) {
        ...
        studio.promptForName("page", wm.findUniqueName("Page", [l]), pages,
				 ...
				 n = wm.capitalize(n);
				 if (this.owner instanceof wm.mobile.PageDialog)
...
wm.Object.extendSchema(wm.mobile.PageContainer, {
