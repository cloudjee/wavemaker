 ...
 */
dojo.provide("wm.base.mobile.Label");
dojo.require("wm.base.mobile.Formatters");

/* TODO: Replace formaters with static/shared/global set of formaters; don't create formatter components for each label */
dojo.declare("wm.mobile.Label", wm.Control, {
	width: "200px",
	height: "24px",
	caption: '',
	link: '',
    ...
    scheduleAutoSize: function() {
	    ...
	    var divObj = wm.mobile.Label.sizingNode;
...
// design only...
wm.Object.extendSchema(wm.mobile.Label, {
    disabled: { ignore: 1 },
...
wm.mobile.Label.description = "A simple label.";

wm.mobile.Label.extend({
        themeable: false,
...
wm.mobile.Label.sizingNode = document.createElement("div");
