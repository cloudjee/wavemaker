 ...
 *         &lt;/element>
 *       &lt;/sequence>
 *       &lt;attGroup ref="{http://www.springframework.org/schema/security}msmds.attlist"/>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
 * </pre>
...
@XmlRootElement(name = "method-security-metadata-source")
public class MethodSecurityMetadataSource {

    @XmlElement(required = true)
    protected List<MethodSecurityMetadataSource.Protect> protect;
    @XmlAttribute
     ...
     * {@link MethodSecurityMetadataSource.Protect }
     * 
     * 
     */
    public List<MethodSecurityMetadataSource.Protect> getProtect() {
        if (protect == null) {
            protect = new ArrayList<MethodSecurityMetadataSource.Protect>();
        }
        return this.protect;
    }
