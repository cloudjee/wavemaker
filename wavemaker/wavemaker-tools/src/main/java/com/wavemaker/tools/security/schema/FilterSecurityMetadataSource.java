...
@XmlRootElement(name = "filter-security-metadata-source")
public class FilterSecurityMetadataSource {

    @XmlElement(name = "intercept-url", required = true)
    protected List<FilterSecurityMetadataSource.InterceptUrl> interceptUrl;
     ...
     * {@link FilterSecurityMetadataSource.InterceptUrl }
     * 
     * 
     */
    public List<FilterSecurityMetadataSource.InterceptUrl> getInterceptUrl() {
        if (interceptUrl == null) {
            interceptUrl = new ArrayList<FilterSecurityMetadataSource.InterceptUrl>();
        }
