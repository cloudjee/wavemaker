...
public class ComplexReturnBean {
    ...
    public static void noTranslationObject(Object o) {
        ...
        if (!(o instanceof JSONObject)) {
            throw new WMRuntimeException("o of wrong type: " + o + ", " + o.getClass());
        }
    }

    public static void singleParameterType(@JSONParameterTypeField(typeParameter = 1) Object o, String type) {

        if (!(o instanceof BeanClass)) {
            throw new WMRuntimeException("Failed to convert; got instance " + o + ", " + o.getClass() + ", type: " + type);
        }
    }

    public static void manyParameterTypes(@JSONParameterTypeField(typeParameter = 1) Object o, String type,
        @JSONParameterTypeField(typeParameter = 1) Object o2, @JSONParameterTypeField(typeParameter = 1) Object o3, String type2) {

        if (!(o instanceof BeanClass)) {
            throw new WMRuntimeException("Failed to convert o; got instance " + o + ", " + o.getClass() + ", type: " + type);
        } else if (!(o2 instanceof BeanClass)) {
            throw new WMRuntimeException("Failed to convert o2; got instance " + o2 + ", " + o.getClass() + ", type: " + type);
        } else if (!(o3 instanceof BeanClass)) {
            throw new WMRuntimeException("Failed to convert o3; got instance " + o3 + ", " + o.getClass() + ", type: " + type2);
        }
    }
    ...
    public static void doTwiceWrappedException() {
        throw new WMRuntimeException(new WMRuntimeException(new FooException(new Exception("foo"))));
    }

    public static String testUpload(@ParamName(name = "param1") String param1, @ParamName(name = "param2") MultipartFile param2) throws IOException {
        return param1 + new String(param2.getBytes());
    }

    public static void testUploadNoRet(@ParamName(name = "param1") String param1, @ParamName(name = "param2") MultipartFile param2)
        throws IOException {
        // do nothing
    }
    ...
    public static void testDownloadNoReturn(@ParamName(name = "param1") String param1) {
        // do nothing
    }
    ...
    /**
     * The DataService query responses return a List of Object[]; this is what Hibernate returns. So, we need to test
     * that.
     */
    // MAV-2060
    ...
    public static String sendLOBs(LOBs lobs) {
        try {
            return IOUtils.toString(lobs.getClob().getCharacterStream()) + ":"
                + Arrays.toString(IOUtils.toByteArray(lobs.getBlob().getBinaryStream()));
        } catch (IOException e) {
    ...
    public static DownloadResponse getLiveDataValue() throws Exception {
        ...
        ReflectServiceWire sw = (ReflectServiceWire) RuntimeAccess.getInstance().getServiceWire("runtimeService");
        ...
        if (!(o instanceof TypedServiceReturn) || !(((TypedServiceReturn) o).getReturnValue() instanceof LiveDataServiceResponse)) {
            ...
            if (!(ldsr.getResult() instanceof ComplexRuntimeServiceBean)) {
                throw new Exception("bad o value: " + ldsr.getResult() + " (" + ldsr.getResult().getClass() + ")");
            }

            ComplexRuntimeServiceBean crsb = (ComplexRuntimeServiceBean) ldsr.getResult();

            ByteArrayInputStream bais = new ByteArrayInputStream(("return: " + crsb.getI()).getBytes());
    ...
    public static class FooException extends Exception {
        ...
        public String getMessage() {
            return "wrapped: " + this.wrapped.getMessage();
        }
