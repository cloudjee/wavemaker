 ...
 * @author Matt Small
 */
public class JavaServiceDefinition2Test extends WMTestCase {

    public void testSupportsRuntime() throws Exception {

        ServiceDefinition def = getServiceDef(this.getClass().getPackage().getName() + ".testtypes." + "JavaServiceDefinitionClass2", null);
    ...
    public void testOverloading() throws Exception {
        ...
        ServiceDefinition def = getServiceDef(this.getClass().getPackage().getName() + ".testtypes." + "JavaServiceDefinitionClass_Overloading", null);
    ...
    public void testParamNameAnnotations() throws Exception {
        ...
        ServiceDefinition def = getServiceDef(this.getClass().getPackage().getName() + ".testtypes." + "JavaServiceDefinitionClass_ParamName", null);
    ...
    public void testGetWithNestedTypeWithArray() throws Exception {
        ...
        ServiceDefinition def = getServiceDef(this.getClass().getPackage().getName() + ".testtypes." + "JavaServiceDefinitionClass_NestedType", null);
    ...
    public void testHiddenMethods() throws Exception {
        ...
        ServiceDefinition def = getServiceDef(this.getClass().getPackage().getName() + ".testtypes." + "JavaServiceDefinitionClass_HiddenMethods",
            null);
    ...
    public void testDefaultHiddenMethods() throws Exception {
        ...
        ServiceDefinition def = getServiceDef(this.getClass().getPackage().getName() + ".testtypes."
    ...
    public void testOutOfOrder_WM_12() throws Exception {
        ...
        ServiceDefinition def = getServiceDef(this.getClass().getPackage().getName() + ".testtypes." + "OutOfOrder_WM_12", null);
    ...
    private ServiceDefinition getServiceDefFromJar(String jarFileName) throws Exception {
        ...
        File srcJarFile = new ClassPathResource(this.getClass().getPackage().getName().replace(".", "/") + "/" + jarFileName).getFile();
        ...
        if (ResourceUtils.isJarURL(runtimeServiceResource.getURL())) {
            ...
            File runtimeClassRoot = runtimeServiceClassFile.getParentFile().getParentFile().getParentFile().getParentFile().getParentFile();
            classRoots.add(runtimeClassRoot);
        }

        ServiceDefinition ret = new JavaServiceDefinition("Foo", "serviceId", classRoots, jarDirs, new ArrayList<String>());
    ...
    private ServiceDefinition getServiceDef(String className, List<File> serviceLibDirs) throws Exception {
        ...
        File queryInfoClassFile = new ClassPathResource(JavaService_BeanClass.class.getName().replace('.', '/') + ".class").getFile();
        File queryInfoClassRoot = queryInfoClassFile.getParentFile().getParentFile().getParentFile().getParentFile().getParentFile();
        classRoots.add(queryInfoClassRoot);

        ClassPathResource runtimeServiceResource = new ClassPathResource(LiveDataService.class.getName().replace(".", "/") + ".class");
        if (ResourceUtils.isJarURL(runtimeServiceResource.getURL())) {
            URL jarUrl = ResourceUtils.extractJarFileURL(runtimeServiceResource.getURL());
        ...
        ClassPathResource typeDefinitionResource = new ClassPathResource(TypeDefinition.class.getName().replace(".", "/") + ".class");
        if (ResourceUtils.isJarURL(typeDefinitionResource.getURL())) {
            ...
            File typeDefinitionClassRoot = typeDefinitionClassFile.getParentFile().getParentFile().getParentFile().getParentFile().getParentFile();
            classRoots.add(typeDefinitionClassRoot);
        }

        return new JavaServiceDefinition(className, "serviceId", classRoots, serviceLibDirs, new ArrayList<String>());
    }
}
