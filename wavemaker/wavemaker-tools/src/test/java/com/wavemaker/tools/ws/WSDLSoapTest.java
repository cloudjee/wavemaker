 ...
 * @author Frankie Fu
 */
public class WSDLSoapTest extends WMTestCase {

    public static WSDL getStockQuoteWSDL() throws Exception {
        return WSDLTest.getWSDL("com/wavemaker/tools/ws/stockquote.wsdl");
    }
    ...
    public static WSDL getSingleCharService() throws Exception {
        return WSDLTest.getWSDL("com/wavemaker/tools/ws/SingleCharService.wsdl");
    }

    public static WSDL getHelloWorldWSDL() throws Exception {
        return WSDLTest.getWSDL("com/wavemaker/tools/ws/HelloWorld.wsdl");
    }
