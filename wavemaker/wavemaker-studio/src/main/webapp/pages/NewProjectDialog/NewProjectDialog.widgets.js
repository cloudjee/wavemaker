...
NewProjectDialog.widgets = {
    layoutBox1: ["wm.Layout", {layoutKind: "top-to-bottom", width: "100%", height: "100%"}, {}, {
        mainPanel: ["wm.studio.DialogMainPanel", {_classes: {domNode:["StudioDarkPanel"]}, backgroundColor:""},{}, {
            ...
            themeName: ["wm.SelectMenu", {_classes: {domNode: ["StudioEditor"]}, emptyValue: "emptyString", width: "100%", height: "24px",  captionSize: "90px", caption: "Theme", displayField: "name", dataField: "dataValue" }, {"onEnterKeyPress":"onOkClick"}, {
        		binding: ["wm.Binding", {}, {}, {
