        ...
        mainInnerPanel: ["wm.Panel", {width: "100%", height: "100%", layoutKind: "top-to-bottom", verticalAlign: "top", horizontalAlign: "left", autoScroll: true}, {}, {
        	tabs: ["wm.studio.TabLayers", {width: "100%", height: "100%", _classes: {domNode: ["StudioTabs", "StudioDarkLayers","NoRightMarginOnTab","StudioDarkerLayers"]}, clientBorder: "1,0,0,1"},{}, {
        		pathLayer: ["wm.Layer", {caption: "Path Inputs"}, {}, {
				    pathLabel: ["wm.Label", {width: "100%", caption: "To add elements to this grid, edit the URL field above and add /${inputName}/ to make \"inputName\" show up in this list", singleLine: false,height:"30px"}],
        		...
        		headerLayer: ["wm.Layer", {caption: "Header Inputs", verticalAlign: "top", horizontalAlign: "right"}, {}, {
					headerLabel: ["wm.Label", {width: "100%", caption: "Mark an input as hidden if you don't want this to show up as an input in your Service Variables", singleLine: false,height:"30px"}],
        		...
        		queryLayer: ["wm.Layer", {caption: "Query String Inputs", verticalAlign: "top", horizontalAlign: "right"}, {}, {
				    inputsLabel: ["wm.Label", {width: "100%", caption: "'Do not encode' option only applies to GET requests.  'Not shown in SVar' option lets you add a parameter to the call that can't be changed by the service variable", singleLine: false, height: "30px"}],
        		...
        		responseLayer: ["wm.Layer", {caption: "Response (required)"}, {}, {
