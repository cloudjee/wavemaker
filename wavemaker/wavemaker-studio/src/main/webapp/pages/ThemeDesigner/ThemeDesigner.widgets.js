...
ThemeDesigner.widgets = {  
	...
	layoutBox1: ["wm.Layout", {height: "100%", width: "100%", horizontalAlign: "left", verticalAlign: "top", layoutKind: "left-to-right"}, {}, {	    
            leftColumn: ["wm.Panel", {layoutKind: "top-to-bottom", width: "335px", height: "100%", horizontalAlign: "left", verticalAlign: "top"},{},{
                themeSelect: ["wm.SelectMenu", {_classes: {domNode: ["StudioEditor"]}, caption: "Select Theme", captionAlign: "right", captionSize: "90px", margin: "0,0,10,0", height: "30px", width: "250px", displayField: "name", dataField: "dataValue", headerVisible: false}, {onchange: "themeselectChange"}, {
		    binding: ["wm.Binding", {}, {}, {
