			...
			panel4a: ["wm.Panel", {"border":"0","height":"100%","horizontalAlign":"center","layoutKind":"left-to-right","margin":"0,0,0,30","padding":"4","width":"100%"}, {}, {
				...
				layers: ["wm.Layers", {"LayersType":"Layers","_classes":{"domNode":["wm_Padding_2px"]}}, {}, {
					...
					ldapMainPanel: ["wm.Panel", {width: "100%", height: "300px", fitToContentHeight: true, margin: "10,50,0,50", horizontalAlign: "left", verticalAlign: "top"}, {}, {
					    ...
					    ldapUserDnPatternInput: ["wm.Text", {_classes: {domNode: ["StudioEditor"]}, width: "500px", captionSize: "150px", "border":"0","caption":"User Search Pattern","emptyValue":"null","padding":"2",helpText: "Filter used to find the user in the directory, starting from the URL base.<br>The only valid variable is {0} which is replaced with the user's login name"}, {"onchange":"setDirty"}],
						...
						ldapGroupRoleAttributeInput: ["wm.Text", {_classes: {domNode: ["StudioEditor"]}, width: "500px", captionSize: "150px", "caption":"Group Role Attribute","emptyValue":"null",helpText: "DN used in group membership attribute.<br>Usually 'cn'"}, {onchange: "setDirty"}],
