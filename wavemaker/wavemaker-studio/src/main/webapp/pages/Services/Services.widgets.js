					...
					webServicePanel: ["wm.Panel", {border: "0", height: "100%", width: "100%"}, {}, {
						panel1: ["wm.Panel", {border: "0", layoutKind: "left-to-right", height: "100%"}, {}, {
							panel2: ["wm.Panel", {border: "0", borderColor: "#000000", width: "100%", padding: "4"}, {}, {
								...
								authUsernameInput: ["wm.Editor", {_classes: {domNode: ["wm_FontColor_Black", "StudioLabel"]}, showing: false, caption: "HTTP Basic Auth Username", captionSize: "240px", height: "24px", emptyValue: "null", layoutKind: "left-to-right"}, {onchange: "editorChange"}, {
									editor: ["wm._TextEditor", {changeOnKey: true}, {}]
								}],
								authPasswordInput: ["wm.Editor", {_classes: {domNode: ["wm_FontColor_Black", "StudioLabel"]}, showing: false, caption: "HTTP Basic Auth Password", captionSize: "240px", height: "24px", emptyValue: "null", layoutKind: "left-to-right"}, {onchange: "editorChange"}, {
								    editor: ["wm._TextEditor", {password: true,changeOnKey: true}, {}]
								}],
								wsConnectionTimeoutInput: ["wm.Editor", {_classes: {domNode: ["wm_FontColor_Black", "StudioLabel"]}, showing: false, caption: "Connection Timeout (milliseconds)", captionSize: "240px", height: "24px", emptyValue: "null", layoutKind: "left-to-right", display: "Number"}, {onchange: "editorChange"}, {
									editor: ["wm._NumberEditor", {changeOnKey: true}, {}]
								}],
								wsRequestTimeoutInput: ["wm.Editor", {_classes: {domNode: ["wm_FontColor_Black", "StudioLabel"]}, showing: false, caption: "Request Timeout (milliseconds)", captionSize: "240px", height: "24px", emptyValue: "null", layoutKind: "left-to-right", display: "Number"}, {onchange: "editorChange"}, {
									editor: ["wm._NumberEditor", {changeOnKey: true}, {}]
								}]
							}]
						}]
