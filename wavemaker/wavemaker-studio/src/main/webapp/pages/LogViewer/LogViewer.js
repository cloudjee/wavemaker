...
dojo.declare("LogViewer", wm.Page, {
        ...
        if (this.logName == "wm.log") {
            ...
            studio.studioService.requestAsync("getLogUpdate", [this.logName, this.lastTimeStamp], function(result) {
                ...
                if (!_this.isDestroyed && _this.logArea && logs) {
                    ...
                    } else _this.logArea.appendHtml(logs);
                }
    ...
    updateLogIfVisible: function() {
        if (!this.root.isAncestorHidden() && this.logName == "wm.log" && this.updateCheckbox.getChecked()) this.showLogs(false);
    },
    updateLog: function() {
        this.showLogs(false);
    },
