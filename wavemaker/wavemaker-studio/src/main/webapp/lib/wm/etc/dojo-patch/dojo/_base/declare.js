...
dojo.declare = function(/*String*/ className, /*Function|Function[]*/ superclass, /*Object*/ props){
	...
	// prepare values
	props = props || {};
	var init = props.constructor, ctor = dd._delegate(superclass), fn;
	// extend to include "props"
	ctor.extend(props);
	// more prototype decoration
	dojo.extend(ctor, {declaredClass: className, _constructor: init, preamble: null});
	// special help for IE
...
dojo.mixin(dojo.declare, {
	...
	_extend: function(props){
		for(var i in props){ if(dojo.isFunction(fn=props[i]) && !0[i]){fn.nom=i;fn.ctor=this;} }
	...
	_core: { 
		...
		inherited: function(name, args, newArgs){
			...
			// we expect 'name' to be prototype 'p'
			fn = p && p[name];
