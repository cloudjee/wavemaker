...
wm.Object.extendSchema(wm.Editor, {
	...
	display: { group: "editor", subgroup: "value", order: 20 },
    editor: {readonly:1,group: "editor", subgroup: "Sub Editor", editor: "wm.prop.SubComponentEditor"},
	displayValue: { bindable: 1, group: "editor", subgroup: "value", order: 40, type: "any"},
	dataValue: { ignore: 1, bindable: 1, group: "editor", order: 45, simpleBindProp: true},
    emptyValue: { group: "editor", subgroup: "value", order: 50, options: ["unset", "null", "emptyString", "false", "zero"]},
