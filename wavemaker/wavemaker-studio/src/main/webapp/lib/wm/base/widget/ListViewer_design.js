...
wm.Object.extendSchema(wm.ListViewer, {
    ...
    pageName: {group: "widgetName", subgroup: "data", type: "string", order: 1, requiredGroup: 1, editor: "wm.prop.PagesSelect"},
    rowBorder: {group: "widgetName", subgroup: "style", type: "string", order: 2},
