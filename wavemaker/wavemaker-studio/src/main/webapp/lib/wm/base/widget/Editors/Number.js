...
dojo.declare("wm.Number", wm.Text, {
    ...
    connectEditor: function() {
        this.inherited(arguments);
        if (this.spinnerButtons) this.addEditorConnect(this.editor, "onClick", this, "changed");
    },

    getEditorConstraints: function() {
       var constraints = {};
       if (!isNaN(parseInt(this.minimum))) constraints.min = Number(this.minimum);
       if (!isNaN(parseInt(this.maximum))) constraints.max = Number(this.maximum);
...
/*
    ...
    */
    ...
    getFormatProps: function() {
        var formatProps = {};
        if (this.places && this.places != '') formatProps.places = parseInt(this.places);
        return formatProps;
    },
...
dojo.declare("wm.Currency", wm.Number, {
    ...
    setEditorValue: function(inValue) {
        var v = inValue;
        if (this.editor) v = dojo.currency.parse(dojo.currency.format(String(v).replace(/[^0-9\-\.]/g, ""), this.editor.constraints), this.editor.constraints)
