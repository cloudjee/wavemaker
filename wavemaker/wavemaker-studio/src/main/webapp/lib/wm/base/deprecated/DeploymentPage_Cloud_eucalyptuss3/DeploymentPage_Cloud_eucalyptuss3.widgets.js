...
DeploymentPage_Cloud_eucalyptuss3.widgets = {
	...
	MainLayers: ["wm.Layers", {width: "100%", height: "100%"}, {}, {
		...
		stepCredentialLabel: ["wm.Label", {_classes: {domNode: ["wm_FontSizePx_14px", "DeploymentHeader"]}, height: "38px", width: "96px", caption: "Enter Eucalyptus account information", margin: "0,0,5,0"}, {}, {
		...
		CreateContainerLayerPanel: ["wm.Panel", {height: "100%", width: "100%", margin: "6"},{}, {
		    containerName: ["wm.Text", {captionSize: "75px", captionAlign: "left", caption: "Container Name", width: "100%", height: "24px", changeOnKey: true}],
		...
		ContainerListLayer: ["wm.Layer", {width: "100%", height: "100%", margin: "10", border: "3", borderColor: "#B0BDD4"}, {onShow: "showContainerList"}, {
