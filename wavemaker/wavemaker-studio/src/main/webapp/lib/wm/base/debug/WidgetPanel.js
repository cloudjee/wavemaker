 ...
 */
    ...
    showWidget: function(inSender, altId) {
        ...
        this.widgetListVar.setQuery(null);
        ...
        try {
            ...
            if (this.selectedItem instanceof wm.Control && !this.selectedItem.isAncestorHidden()) {
                ...
                dojo.marginBox(this.selectionNode, {
                    l: parseInt(coords.x),
                    t: parseInt(coords.y),
                    w: coords.w,
                    h: coords.h
    ...
    searchChange: function(inSender) {
        ...
        if (className) {
            var obj = dojo.getObject("wm." + className);
            if (!obj || obj.prototype instanceof wm.Component === false) {
                q.type = "*" + className + "*";
            }
        }
        ...
        if (!wm.isMobile) {
            ...
            this.widgetGrid.setScrollTop(0);
        }
    },
   activate: function() {
