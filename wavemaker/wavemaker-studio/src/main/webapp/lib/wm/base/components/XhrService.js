...
dojo.declare("wm.XhrService", wm.Service, {
	...
	if (useProxy) {
		...
		this.jsonRpcService = new wm.JsonRpcService({owner: inOwner, service: "waveMakerService"});
	...
	dInternal.addCallbacks(dojo.hitch(this, "onResult", parameters, op, d),
			       dojo.hitch(this, "onError", parameters, op, d));
	return d;
    },
