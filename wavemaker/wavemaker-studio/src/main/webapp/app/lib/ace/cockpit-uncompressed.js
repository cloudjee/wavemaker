/* ***** BEGIN LICENSE BLOCK *****
 * [PLEASE NOTE: CLOUDJEE, INC. ELECTS TO USE AND DISTRIBUTE THIS COMPONENT UNDER THE TERMS OF THE LGPL 2.1.
...
defineace('cockpit/index', ['requireace', 'exports', 'module' , 'pilot/index', 'cockpit/cli', 'cockpit/ui/settings', 'cockpit/ui/cli_view', 'cockpit/commands/basic'], function(requireace, exports, module) {


exports.startup = function(data, reason) {
  requireace('pilot/index');
  requireace('cockpit/cli').startup(data, reason);
  // window.testCli = requireace('cockpit/test/testCli');

  requireace('cockpit/ui/settings').startup(data, reason);
  requireace('cockpit/ui/cli_view').startup(data, reason);
  requireace('cockpit/commands/basic').startup(data, reason);
};
...
defineace('cockpit/cli', ['requireace', 'exports', 'module' , 'pilot/console', 'pilot/lang', 'pilot/oop', 'pilot/event_emitter', 'pilot/types', 'pilot/canon'], function(requireace, exports, module) {
...
//var keyboard = requireace('keyboard/keyboard');
var types = requireace('pilot/types');
var Status = requireace('pilot/types').Status;
var Conversion = requireace('pilot/types').Conversion;
...
defineace('cockpit/ui/settings', ['requireace', 'exports', 'module' , 'pilot/types', 'pilot/types/basic'], function(requireace, exports, module) {
...
defineace('cockpit/ui/cli_view', ['requireace', 'exports', 'module' , 'text!cockpit/ui/cli_view.css', 'pilot/event', 'pilot/dom', 'pilot/keys', 'pilot/canon', 'pilot/types', 'cockpit/cli', 'cockpit/ui/request_view'], function(requireace, exports, module) {


var editorCss = requireace("text!cockpit/ui/cli_view.css");
...
var CliRequisition = requireace('cockpit/cli').CliRequisition;
var Hint = requireace('cockpit/cli').Hint;
var RequestView = requireace('cockpit/ui/request_view').RequestView;
...
defineace('cockpit/ui/request_view', ['requireace', 'exports', 'module' , 'pilot/dom', 'pilot/event', 'text!cockpit/ui/request_view.html', 'pilot/domtemplate', 'text!cockpit/ui/request_view.css'], function(requireace, exports, module) {

var dom = requireace("pilot/dom");
var event = requireace("pilot/event");
var requestViewHtml = requireace("text!cockpit/ui/request_view.html");
var Templater = requireace("pilot/domtemplate").Templater;

var requestViewCss = requireace("text!cockpit/ui/request_view.css");
...
function imageUrl(path) {
    var dataUrl;
    try {
        dataUrl = requireace('text!cockpit/ui/' + path);
    } catch (e) { }
    if (dataUrl) {
        return dataUrl;
    }
...
defineace('pilot/domtemplate', ['requireace', 'exports', 'module' ], function(requireace, exports, module) {
...
defineace('cockpit/commands/basic', ['requireace', 'exports', 'module' , 'pilot/canon'], function(requireace, exports, module) {
...
defineace("text!cockpit/ui/cli_view.css", [], "" +
...
defineace("text!cockpit/ui/request_view.css", [], "" +
  ".cptRowIn {" +
...
defineace("text!cockpit/ui/request_view.html", [], "" +
  "<div class=cptRow>" +
