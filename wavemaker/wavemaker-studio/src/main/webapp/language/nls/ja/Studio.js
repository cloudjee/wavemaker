 ...
 */
{
	editVariableDialog: {title: "JSONを編集"},
	...
	navigationMenu: {localizationStructure:
		{
			"projectPopupBtn": "ファイル",
			"newProjectItem": "新しいプロジェクト...",
			"saveProjectItem": "保存",
			"openProjectItem": "プロジェクトを開く...",
			"closeProjectItem": "プロジェクトを閉じる",
			"copyProjectItem": "現在のプロジェクトを複製...",
			"deleteProjectItem": "現在のプロジェクトを削除",
			"exportProjectItem": "プロジェクトをエクスポート",
			"importProjectItem": "プロジェクトをインポート...",
			"deployProjectItem": "配布...",
			"newProjectDeployItem": "新規配布...",
			"settingsDeployClick": "deploySettingsItem...",
			"cloudfoundryManagementItem": "CloudFoundryアプリを管理...",
			"preferencesItem": "環境設定...",
			"modifyStudioItem": "スタジオを更新",
			"studioPatchesItem": "スタジオパッチをアップロード...",
			"partnerServicesItem": "パートナーサービスをインポート...",
			...
			"pagePopupBtn": "ページ",
			"newPageItem": "新規作成...",
			"saveAsPageItem": "名前をつけて保存...",
			"importPageItem": "ページをインポート...",
			"deletePageItem": "削除",
			"setHomePageItem": "ホームページに設定",
			"servicesPopupBtn": "サービス"
		}
	},
	runPopup: {caption: "実行", 
