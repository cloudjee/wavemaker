...
LOADING: "ロードしています...",
AVATAR_DROP: "<b>${caption}</b>を<b>${target}</b>にドロップします",
CONFIRM_DELETE: "${name}という名前の${type}を削除しますか？",
ALERT_NAME_EXISTS: "ファイル名はすでに使われています",
ALERT_CREATE_FOLDER_FAILED: "フォルダの作成に失敗しました",
ALERT_RENAME_FAILED:  "ファイル名の変更に失敗しました",
ALERT_RENAME_SUCCESS: "ファイル名が${fileName}に変更されました",
CAPTION_RELATIVE_URL:  "相対URL:",
CAPTION_CLASSPATH:  "クラスパスに入っていますか？",
ALERT_DELETE_FAILED: "${fileName}が削除できませんでした",
ALERT_UNZIP_FAILED:  "ファイルを解凍できませんでした",
