...
CONFIRM_UNDEPLOY: "Are you sure you want to undeploy ${projectName} ?",
WAIT_SAVE: "Saving...",
...
ALERT_DEPLOY_SUCCESS: "<div style=' line-height: 18px;word-break: break-all; position: relative; top: -4px; width: 100%; padding: 0 0 0 5px;'><p style='margin: 0;'><b>Project deployed to</b></p><p style='margin: 0;'><a target='_NewWindow' href='${url}'>${url}</a></p><p style='margin: 0;'><b>Version</b>: ${version}</p></div>",
