...

{
    ...
    MENU_REDEPLOY: "Deploy to ${deploymentName}...",
...
/*    ALERT_IMPORT_COMPONENT_SUCCESS: "Component '${name}' Imported",
    ...
    "wm.EventEditor.NEW_NOTIFICATION": " - New Notification...",
    "wm.EventEditor.LIST_NAVIGATION": "Navigations:",
    "wm.EventEditor.LIST_NOTIFICATION": "Notifications:",
